...
//,S_0_1,S_2_3,S_4_6,S_7UP
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,S_Single,S_Double from tennis where `MID`=$gid  and cancel<>1 and fopen=1";// `m_start`>now() and
//echo $mysql;   //
//exit;
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/TN_order/TN_order_t_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
