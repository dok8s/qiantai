...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Win,TG_Win,M_Flat from tennis where `MID`=$gid";// `m_start`>now() and
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/TN_order/TN_order_m_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
