...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,M_Dime,$m_league as M_League,M_Dime,MB_Dime_Rate,TG_Dime_Rate from tennis where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/TN_order/TN_order_ou_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
