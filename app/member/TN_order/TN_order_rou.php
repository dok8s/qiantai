...
$base_url = "".$site."/app/member/TN_index.php?rtype=rou&uid=$suid&langx=zh-cn&mtype=3";
$thisHttp = new cHTTP();
$thisHttp->setReferer($base_url);
$filename="".$site."/app/member/TN_order/TN_order_rou.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
//////////////////////////////////////////////////
$mysql = "select maxgold,mb_ball,tg_ball,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,concat('$body_mb_dimes',m_re_dime) as MB_Dime,concat('$body_tg_dimes',m_re_dime) as TG_Dime,mb_re_dime_rate as MB_Dime_Rate,tg_re_dime_rate as TG_Dime_Rate from tennis where `MID`=$gid and cancel<>1 and fopen=1";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/TN_order/TN_order_rou_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
