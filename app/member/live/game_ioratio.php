...
$base_url = "".$site."/app/member/live/game_ioratio_view.php?uid=$suid&langx=$langx&gidm=$gidm&gdate=$gdate&gtype=".$gtype;
$thisHttp = new cHTTP();
$thisHttp->setReferer($base_url);
$filename = "".$site."/app/member/live/game_ioratio.php?uid=$suid&langx=$langx&gdate=$gdate&gtype=".$gtype;
