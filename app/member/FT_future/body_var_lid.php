		...
		<form name='lid_form'>
			<table class="bet_select_table" cellpadding="0" cellspacing="0" border="0">
				...
				<tr class="bet_select_title">
					<td colspan="6">
						<div class="bet_select_left">选择联赛123</div>
				...
				<tr>
					<td colspan="6" class="bet_select_text">热门联赛123</td>
				</tr>
				<?
				$mDate=date('m-d');
				if ($rtype<>'re'){
					$mysql = "select distinct  M_League FROM `foot_match` WHERE `m_Date` >'$mDate' and (r_show=3 or r_show=4)";
				}else{
