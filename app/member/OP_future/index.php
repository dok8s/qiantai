...
function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
	...
	//alert(parent.name)
	var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('BS','"+wtype+"','"+param+"');\" title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+" class='bet_bg_color'>"+ioratio+"</font></a>";
...
<!--SCRIPT language=javaScript src="/js/BS_mem_showgame_<?=$rtype?>.js" type=text/javascript></SCRIPT-->
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0">
  <frame name="body_var" scrolling="NO" noresize src="body_var.php?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&mtype=<?=$mtype?>&g_date=<?=$g_date?>&league_id=<?=$league_id?>">
