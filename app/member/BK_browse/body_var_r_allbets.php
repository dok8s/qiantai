...
function reloadGameData(){
  ...
  getHTML.loadURL("/app/member/get_game_allbets.php","POST", getUrlParam());
	iorPHP.location.href="/app/member/BK_browse/aaa.php?"+getUrlParam();
}
						...
						if(tab_model.nodeName =="TABLE"&&tab_model.id.indexOf("model")!=-1){
								...
								for(var ms_num=0;ms_num<=6;ms_num++){
									...
									for(var k=0; k<gid_ary.length; k++){
										...
										tmpScreen = tmpScreen.replace(/\*TITLE_TEAM_H\*/g, "title='"+team_h+"'");
...
function closeClickEvent(){
		...
		parent.document.getElementById('more_window').style.display='none';		     
		parent.parent.body_browse.document.getElementById('MFT').className="bodyset BKR";
...
<table id="tab_show" border="0" cellspacing="0" cellpadding="0" class="more_table">
	...
	<table id="gameInfo" width="100%" border="0" cellspacing="0" cellpadding="0" class="more_bg_table_bk">
		<tr class="more_bg1">
            <td id="title_showtype" name="title_showtype" class="more_live"><span class="more_ln">*LIVE*</span><img src="/images/member/zh-tw/more_n.jpg" class="more_n" *MID_DISPLAY*/></td>
            <td></td>
		 	...
		 	<table id="model_R" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th colspan="2" class="more_title4">
							...
							<span class="more_star_bg"><span id="star_R*MS*" name="star_R*MS*" onClick="addFavorites('R*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
			...
			<table id="model_OU" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="2">
							...
							<span class="more_og2">*MS_STR*</span>
							<span class="more_star_bg"><span id="star_OU*MS*" name="star_OU*MS*" onClick="addFavorites('OU*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
		 	...
		 	<table id="model_OUH" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="2">
							...
							<span class="more_star_bg"><span id="star_OUH*MS*" name="star_OUH*MS*" onClick="addFavorites('OUH*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
				
				<!-- START DYNAMIC BLOCK: OUH -->
				<tr class="*TR_CLASS*">
						<td id="*OUHO_GID*" onClick="betEvent('*GID*','OUHO','*IORATIO_OUHO*','OUH');" style="cursor:pointer"  class="*TD_CLASS_OUHO*" width="50%"><div class="more_font"><span class="m_team"><?=$strOver?></span><span class="m_middle">*RATIO_OUHO*</span><span class="m_red_bet" title="<?=$strOver?>">*IORATIO_OUHO*</span></div></td>
						<td id="*OUHU_GID*" onClick="betEvent('*GID*','OUHU','*IORATIO_OUHU*','OUH');" style="cursor:pointer"  class="*TD_CLASS_OUHU*" width="50%"><div class="more_font"><span class="m_team"><?=$strUnder?></span><span class="m_middle">*RATIO_OUHU*</span><span class="m_red_bet" title="<?=$strUnder?>">*IORATIO_OUHU*</span></div></td>
				</tr>
		 	...
		 	<table id="model_OUC" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="2">
							...
							<span class="more_star_bg"><span id="star_OUC*MS*" name="star_OUC*MS*" onClick="addFavorites('OUC*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
				
				<!-- START DYNAMIC BLOCK: OUC -->
				<tr class="*TR_CLASS*">
						<td id="*OUCO_GID*" onClick="betEvent('*GID*','OUCO','*IORATIO_OUCO*','OUC');" style="cursor:pointer"  class="*TD_CLASS_OUCO*" width="50%"><div class="more_font"><span class="m_team"><?=$strOver?></span><span class="m_middle">*RATIO_OUCO*</span><span class="m_red_bet" title="<?=$strOver?>">*IORATIO_OUCO*</span></div></td>
						<td id="*OUCU_GID*" onClick="betEvent('*GID*','OUCU','*IORATIO_OUCU*','OUC');" style="cursor:pointer"  class="*TD_CLASS_OUCU*" width="50%"><div class="more_font"><span class="m_team"><?=$strUnder?></span><span class="m_middle">*RATIO_OUCU*</span><span class="m_red_bet" title="<?=$strUnder?>">*IORATIO_OUCU*</span></div></td>
				</tr>
		 	...
		 	<table id="model_PDH" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="5">
							...
							<!--span class="more_og2">*MS_STR*</span-->
							<span class="more_star_bg"><span id="star_PDH*MS*" name="star_PDH*MS*" onClick="addFavorites('PDH*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
				...
				<tr class="*TR_CLASS*">
						<td id="*PDH0_GID*" onClick="betEvent('*GID*','PDH0','*IORATIO_PDH0*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDH0*" width="20%"><span style="float: left;">0 <?=$huozhe?> 5</span><span class="m_red2" title="0 <?=$huozhe?> 5">*IORATIO_PDH0*</span></td>
						<td id="*PDH1_GID*" onClick="betEvent('*GID*','PDH1','*IORATIO_PDH1*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDH1*" width="20%"><span style="float: left;">1 <?=$huozhe?> 6</span><span class="m_red2" title="1 <?=$huozhe?> 6">*IORATIO_PDH1*</span></td>
						<td id="*PDH2_GID*" onClick="betEvent('*GID*','PDH2','*IORATIO_PDH2*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDH2*" width="20%"><span style="float: left;">2 <?=$huozhe?> 7</span><span class="m_red2" title="2 <?=$huozhe?> 7">*IORATIO_PDH2*</span></td>
						<td id="*PDH3_GID*" onClick="betEvent('*GID*','PDH3','*IORATIO_PDH3*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDH3*" width="20%"><span style="float: left;">3 <?=$huozhe?> 8</span><span class="m_red2" title="3 <?=$huozhe?> 8">*IORATIO_PDH3*</span></td>
						<td id="*PDH4_GID*" onClick="betEvent('*GID*','PDH4','*IORATIO_PDH4*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDH4*" width="20%"><span style="float: left;">4 <?=$huozhe?> 9</span><span class="m_red2" title="4 <?=$huozhe?> 9">*IORATIO_PDH4*</span></td>
				</tr>                                                                                                       
		 	...
		 	<table id="model_PDC" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="5">
							...
							<!--span class="more_og2">*MS_STR*</span-->
							<span class="more_star_bg"><span id="star_PDC*MS*" name="star_PDC*MS*" onClick="addFavorites('PDC*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
				...
				<tr class="*TR_CLASS*">
						<td id="*PDC0_GID*" onClick="betEvent('*GID*','PDC0','*IORATIO_PDC0*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDC0*" width="20%"><span style="float: left;">0 <?=$huozhe?> 5</span><span class="m_red2" title="0 <?=$huozhe?> 5">*IORATIO_PDC0*</span></td>
						<td id="*PDC1_GID*" onClick="betEvent('*GID*','PDC1','*IORATIO_PDC1*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDC1*" width="20%"><span style="float: left;">1 <?=$huozhe?> 6</span><span class="m_red2" title="1 <?=$huozhe?> 6">*IORATIO_PDC1*</span></td>
						<td id="*PDC2_GID*" onClick="betEvent('*GID*','PDC2','*IORATIO_PDC2*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDC2*" width="20%"><span style="float: left;">2 <?=$huozhe?> 7</span><span class="m_red2" title="2 <?=$huozhe?> 7">*IORATIO_PDC2*</span></td>
						<td id="*PDC3_GID*" onClick="betEvent('*GID*','PDC3','*IORATIO_PDC3*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDC3*" width="20%"><span style="float: left;">3 <?=$huozhe?> 8</span><span class="m_red2" title="3 <?=$huozhe?> 8">*IORATIO_PDC3*</span></td>
						<td id="*PDC4_GID*" onClick="betEvent('*GID*','PDC4','*IORATIO_PDC4*','PD');" style="cursor:pointer"  class="*TD_CLASS_PDC4*" width="20%"><span style="float: left;">4 <?=$huozhe?> 9</span><span class="m_red2" title="4 <?=$huozhe?> 9">*IORATIO_PDC4*</span></td>
				</tr>                                                                                                       
			...
			<table id="model_M" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="3">
							...
							<span class="more_og2">*MS_STR*</span>
							<span class="more_star_bg"><span id="star_M*MS*" name="star_M*MS*" onClick="addFavorites('M*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
		 	...
		 	<table id="model_EO" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="2">
							...
							<span class="more_og2">*MS_STR*</span>
							<span class="more_star_bg"><span id="star_EO*MS*" name="star_EO*MS*" onClick="addFavorites('EO*MS*');" class="star_down" title="<?=$addtoMyMarket?>"></span></span>
						</th>
				</tr>
				
				<!-- START DYNAMIC BLOCK: EO -->
				<tr class="*TR_CLASS*">
						<td id="*EOO_GID*" onClick="betEvent('*GID*','ODD','*IORATIO_EOO*','EO');" style="cursor:pointer"  class="*TD_CLASS_EOO*" width="50%"><div class="more_font"><span class="m_team"><?=$Odd?></span><span class="m_red_bet" title="<?=$Odd?>">*IORATIO_EOO*</span></div></td>
						<td id="*EOE_GID*" onClick="betEvent('*GID*','EVEN','*IORATIO_EOE*','EO');" style="cursor:pointer"  class="*TD_CLASS_EOE*" width="50%"><div class="more_font"><span class="m_team"><?=$Even?></span><span class="m_red_bet" title="<?=$Even?>">*IORATIO_EOE*</span></div></td>
				</tr>
