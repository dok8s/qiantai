...
<body id="HFT" class="bodyset" onLoad="SetRB('FT','10697e3bm6439161l260158');onloaded();" >
<div id="container">
  <input type="hidden" id="uid" name="uid" value="10697e3bm6439161l260158">
  ...
  <div id="welcome">
	<ul class="level1">
      <!--会员帐号-->
      <li class="name">您好, <strong id="userid">dwh1313</strong>
...
<!--div class="info" id="informaction" onMouseOver="OnMouseOverEvent()">
  <table border="0" cellpadding="0" cellspacing="0" id="mose" onMouseOut="OnMouseOutEvent();">
    <tr>
      <td><a href="#"><font id="chg_pwd" onClick="Go_Chg_pass();" style="cursor:hand">&bull;&nbsp; 修改密码</font></a></td>
      <td ><a href="http://w148.hg3088.com/tpl/member/zh-cn/roul_new/roul.html" target="_blank">&bull;&nbsp; 规则说明</a></td>
      <td><a href="/tpl/member/zh-tw/virus_site01.html" target="_blank">&bull;&nbsp; 防毒软件设置说明</a></td>
    </tr>
    <tr>
      <td><a href="http://w148.hg3088.com/app/member/account/mem_data.php?uid=10697e3bm6439161l260158&langx=zh-cn" target="body">&bull;&nbsp; 会员资料</a></td>
      <td><a href="http://w148.hg3088.com/tpl/member/zh-cn/roul_mp.html" target="_blank">&bull;&nbsp; 手机交易</a></td>
      <td><a href="javascript://" onClick="javascript: window.open('/tpl/member/zh-tw/way.html','','menubar=no,status=yes,scrollbars=no,top=150,left=200,toolbar=no,width=540,height=510')">&bull;&nbsp; 盘口使用方法</a></td>
    </tr>
    <tr id="QA_row">
      <td title="筹备中"><a href="http://122.146.29.39" target="_blank" >&bull;&nbsp; 网路安全工具</a></td>
      <td><a href="http://web.asd10000.com/" target="_blank">&bull;&nbsp; 服务中心</a></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</div-->
 
<!--div id="extra1" style="display: none"><span><a href="http://w148.hg3088.com/app/member/FT_browse/index.php?rtype=re&uid=10697e3bm6439161l260158&langx=zh-cn&mtype=4&showtype=" target="body">滚球</a></span></div-->
<!--div id="head_date" style="display:none;"><span id=head_year></span>年<span id=head_month></span>月<span id=head_day></span>日 <span id=head_hour></span>:<span id=head_min></span></div-->
