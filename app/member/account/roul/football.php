<span class="acc_rules_date">最后更新日期: 11/07/2017</span>
<h1>足球</h1>

<!-- buttons -->
<table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
    <tr>
        <td width="33.33%"><a href="#General Rules"><div class="acc_rulesSoccerBTN">一般规则</div></a></td>
        <td width="33.33%"><a href="#mainmarkets"><div class="acc_rulesSoccerBTN">主要市场</div></a></td>
        <td width="33.33%"><a href="#GoalMarkets"><div class="acc_rulesSoccerBTN">进球集锦</div></a></td>
    </tr>
    <tr>
        <td><a href="#PlayersMarkets"><div class="acc_rulesSoccerBTN">球员</div></a></td>
        <td><a href="#Specials"><div class="acc_rulesSoccerBTN">特别</div></a></td>
        <td><a href="#Corners"><div class="acc_rulesSoccerBTN">角球</div></a></td>
    </tr>
    <tr>
        <td><a href="#BookingsCards"><div class="acc_rulesSoccerBTN">牌/卡</div></a></td>
        <td><a href="#FreeKicks"><div class="acc_rulesSoccerBTN">任意球</div></a></td>
        <td><a href="#GoalKicks"><div class="acc_rulesSoccerBTN">射门</div></a></td>
    </tr>
    <tr>
        <td><a href="#ThrowIns"><div class="acc_rulesSoccerBTN">界外球</div></a></td>
        <td><a href="#Substitutions"><div class="acc_rulesSoccerBTN">替换</div></a></td>
        <td><a href="#Offsides"><div class="acc_rulesSoccerBTN">越位</div></a></td>
    </tr>
    <tr>
        <td><a href="#PenaltyMarkets"><div class="acc_rulesSoccerBTN">点球</div></a></td>
        <td><a href="#Competitions"><div class="acc_rulesSoccerBTN">比赛</div></a></td>
        <td><a href="#OtherMarkets"><div class="acc_rulesSoccerBTN">其他</div></a></td>
    </tr>
</table>
<!-- buttons -->

<!-- general rules -->
<div id="General Rules" class="acc_rulesSoccer_Title">一般规则</div>
<ul>
...
<!-- main rules -->
<div id="mainmarkets" class="acc_rulesSoccer_Title">主要市场</div>

<h2>让球盘</h2>
<h3>一般规则</h3>
<ul>
    <li>预测哪一支球队在盘口指定的让球数在全场/半场/赛事某个时节赢得比赛。</li>
    <li>&ldquo;让球盘&rdquo;则定义为在比赛正式开始前，一方球队已得到另一方让的虚拟分数，以领先的情况下开始比赛。</li>
    <li>所有注单将按盘口开出的让球数在玩法的时节结束后结算。</li>
    <li>让球队（优势球队）将给出让球，让球数将显示在赔率的左侧，让球队在盘面上也会以粗型字体显示</li>
    <li>让球盘的玩法分为以下几种：</li>
    <ul>
        <li>整数让球也或称为让&lsquo;一球&rsquo;（如：-1，-2，-3，等）</li>
        <li>非整数让球也或称为&lsquo;半球&rsquo;（如：-0.5，-1.5，-2.5，等）</li>
        <li>混合以上让&lsquo;半球/一球&rsquo;的方式（如：-0/0.5，-0.5/1，-1/1.5，等）</li>
    </ul>
</ul>
<h3>让球</h3>
<ul>
...
<ul>
    ...
    <li>结算是以投注时到比赛/时节结束后的赛果做裁决。即是以赛事完场比分减去投注当时的比分。上半场的滚球让球投注将以上半场结束后的赛果结算。 </li></ul>
<h3>加时赛 - 让球</h3>
<ul>
...
<ul>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="acc_rulesTB">
        <tr>
...
<ul>
    ...
    <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响赛事结果的情况，大/小盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。请参考以上范例：</li>
    <ul>
        <li>范例1：会员投注大于2.5球：</li>
        <ul class="acc_romaUL">
            <li>赛事在比分2-1时中断。</li>
            <li>尽管赛事中断，但因结果已经明确并且若之后有任何潜在进球将对盘口结算裁决没有影响，所有此会员注单结算为赢。</li>
        </ul>
        <li>范例2：会员投注小于2.5球：</li>
        <ul>
            <li>赛事在比分2-1时中断。</li>
            <li>尽管赛事中断，但因结果已经明确并且若之后有任何潜在进球将对盘口结算裁决没有影响，所有此会员注单结算为输。</li>
        </ul>
        <li>范例3：会员投注大于3.5球：</li>
        <ul>
            <li>赛事在比分2-1时中断。</li>
...
<h3>滚球大小盘</h3>
<ul> <li>结算是以比赛/时节结束后的总入球数做裁决。投注当时，赛事的比分将视为0-0来计算。</li></li></ul>
<h3>加时赛 - 进球: 大 / 小</h3>
<ul>
...
<ul>
    ...
    <li>如果比赛被中断，所有将要进行的15分钟时段投注将被视为无效。任何15分钟时段投注，如果该时段中赛事进行完整，此注单将被视为有效。在15分钟时段中，如果赛事已有明确结果并且之后对赛事没有任何影响，总进球数大/小盘注单才会被结算。任何其他的情况，投注将被视为无效。</li>
    <table width="100%" cellspacing="0" cellpadding="0" class="acc_rulesTB">
        <tr>
            <td width="50%">15分钟-时段1</td>
            <td width="50%">上半场开始-14分59秒</td>
...
<h3>独赢</h3>
<ul><li>预测哪一支球队将在90分钟比赛胜出或赛事和局。 </li></ul>
<h3>独赢 - 上半场</h3>
<ul><li>所有上半场的投注将以上半场45分钟赛果结算。</li></ul>
<h3>滚球独赢</h3>
<ul>
    <li>预测滚球时，哪一支球队胜出。</li>
    ...
    <table width="100%" class="acc_rulesTB" cellspacing="0" cellpadding="0">
        <tr>
            <th >&nbsp;</th>
            <th >目前得分</th>
            <th >赔率</th>
    ...
    <ul>
        <li>范例1：在赛事比分为阿森纳1-0曼联时，会员投注滚球独赢盘 – 阿森纳赢：</li>
        <ul>
            <li>完场赛果为阿森纳2-1曼联。</li>
            <li>因阿森纳在完场时胜出，所有投注阿森纳的注单结算为赢。</li>
            <li>所有在比分1-0时投注曼联或平局的注单将结算为输。</li>
        </ul>
        <li>范例2：在赛事比分为阿森纳1-0曼联时，会员投注滚球独赢盘 –曼联赢：</li>
        <ul>
            <li>完场赛果为阿森纳1-1曼联。</li>
...
<ul>
    ...
    <li>如果比赛在加时赛结束前暂停，取消或中止，所有投注将被视为无效。 </li></ul>
<h3>加时赛 - 独赢 - 上半场</h3>
...
<ol>
    ...
    <ul>
        ...
        <li>若最终比分为：0-0，将会按照&ldquo;双&rdquo;来计算。 </li>
    </ul>
...
<ol>
    ...
    <ul>
        ...
        <li>如果注单在赛事中断前已得到明确的胜负，并且任何进一步的赛果均不会对注单结果产生影响的情况下，注单会被视为有效。</li></ul>
    <h4>波胆 - 上半场</h4>
    <ul>
        <li>预测一场特定赛事半场的准确比分。</li>
        <li>半场波胆投注是指投注上半场的比赛，投注的结算根据半场&ldquo;45分钟&rdquo;结束后的比分做出裁决。</li>
        <li>如果注单在赛事中断前已得到明确的胜负，并且任何进一步的赛果均不会对注单结果产生影响的情况下，注单会被视为有效。</li>
        <li>如果赛事在下半场取消，所有半场波胆的投注被视为有效。  </li>
    </ul>
</ol>
<h3>半场/全场</h3>
<ul><li>预测赛事的半/全场结果。</li></li></ul>
<h3>净胜球数</h3>
<ul >
...
<h3>落后反超获胜</h3>
<ul>
    <li>预测哪一支球队在比赛的任何时间里都为输，然而却在最后&ldquo;90分钟&rdquo;反超为赢。</li>
    <li>选择的球队必须在比赛的任何时间里都为输，但是在接下来的最后&ldquo;90分钟&rdquo;却获胜为赢。 </li>
    <li>如果比赛被中断，所有的投注均视为无效。</li></ul>
<h3>平局退单</h3>

<ul><li>预测哪一支球队将在比赛胜出。但若比赛结果为平局，所有投注将被取消。 </li></ul> </li>
</ul>

<!-- content abc -->

<!-- goal rules -->
<div class="acc_rulesSoccer_Title" id="GoalMarkets">进球集锦</div>
...
<ul>
    ...
    <li>选择投注球队不需要赢得比赛，例如：赛果 0-0，注单为赢。</li></ul>
<h3>零失球获胜</h3>
<ul>
    <li>预测您投注的球队在90分钟完场时间内没有失球及没让敌方攻入任何一球。</li>
    <li>无失球'是指球队在赛事中没让敌方攻入任何一球，争取完美防守。 </li></ul>
<h3>先进2球/3球的一方</h3>
<ul>
...
<h3>最多进球的半场</h3>
<ul>
    <li>在赛事90分钟结束后，猜测哪个&ldquo;45分钟&rdquo;半场入球最多。</li>
...
<ul>
    ...
    <li>盘口提供三种投注选择，如上下半场入球数一样，投注&ldquo;和&rdquo;将会为赢。</li>
    <li>选项可列为：</li>
</ul>
<ul START="5">
    <ul>
...
<ul START="3">
    ...
    <li>范例：如果投注首个进球时间的选项是&lsquo;赛事的第26分钟或之前&rsquo;，而确实进球的时间为26分钟49秒，进球的范围属于&lsquo;第27分钟后&rsquo;，因此投注将结算为输。</li>
    <li>如果赛事在首个进球后中断，所有首个进球时间的注单将保持有效。</li>
    <li>如果赛事在没有进球前中断，所有首个进球时间的注单将被取消。</li>
    <li>乌龙球将予以计算在内。裁判判定无效的进球是将不予以计算在内。</li></ul>
<h3>首个进球时间</h3>
<ul>
...
<div class="acc_rulesSoccer_Title" id="PlayersMarkets">球员</div>
<h3>最先进球球员</h3>
<ul>
...
<ul>
    ...
    <li>如果赛事在没有进球前中断，所有投注最后进球球员的注单将被取消。</li></ul>
<h3>任何时间进球球员</h3>
<ul>
    ...
    <h3>独赢</h3>
    <ul>
        <li>预测哪一个球员将在比赛中入球最多，盘口同样提供选择&ldquo;平局/和&rdquo;。</li>
        <li>如果赛事中断或推迟，所有注单将会被取消，除非赛事已有明确结果并且之后入球对赛事没有任何影响。</li>
    </ul>
    <h3>单 / 双</h3>
    <ul>
        ...
        <li>如果赛事中断或推迟，所有注单将会被取消，除非赛事已有明确结果并且之后入球对赛事没有任何影响。 </li>
        <li>若比赛没有球员进球，赛果为0，投注&lsquo;双&rsquo;注单为赢。</li>
    </ul>
</ul>
<!-- content abc -->

<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="Specials">特别</div>
<h3>开球球队</h3>
<ul>
    <li>预测在比赛先开球的球队。</li>
...
<ul>
    ...
    <li>如果赛事在官方时间90分钟之内中断，所有投注双半场总伤停补时的注单将会取消。</li></ul>
<!-- content abc -->

<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="Corners">角球</div>
<h3>角球：一般规则</h3>
<ul>
...
<h3>角球: 大 / 小 - 上半场</h3>
<ul>
    <li>P预测在45分钟后完成时间内总获得的角球将大于或小于在盘口指定的大/小盘球数。 </li>
    <li>如果赛事获得的总角球数多于盘口的大/小盘球数，则为大盘。如果少于盘口的大/小盘球数，则为小盘。</li>
...
<ul>
    ...
    <li>若比赛没有角球，结果为0，投注&lsquo;双&rsquo;注单将会盈利。 </li>
    <li>如果赛事在上半场中断，所有注单将被视为无效，除非赛事已有明确结果并且之后角球对赛事没有任何影响。</li>
</ul>
<h3>角球: 单 / 双 - 上半场</h3>
<ul>
    ...
    <li>如果赛事在上半场中断，所有注单将被视为无效，除非赛事已有明确结果并且之后角球对赛事没有任何影响。 </li>
    <li>如果赛事在下半场中断，所有投注上半场角球单/双盘将会被视为有效。</li></ul>
...
<ul START="3">
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
    <li>范例：如果投注首个角球时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实踢角球的时间为8分钟49秒，踢角球时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。</li>
    <li>如果赛事在获得第一个角球后中断，所有首个角球时间的注单将保持有效。 </li>
    <li>如果赛事在没有获得角球前中断，所有首个角球时间的注单将被取消。</li>
    <li>如果在90分钟完场时间内并未获得角球，所有首个角球时间的注单将被取消。 </li>
    <li>如果首个角球需重新进行，那首个角球时间将以重新进行的角球时间为准。 </li></ul>
<h3>15分钟角球数</h3>
<ul>
    <li>依照以上主要市场陈列的15分钟规则，预测哪队将在让球，独赢，大小或单双盘口取得胜利。</li></ul>
<!-- content abc -->

<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="BookingsCards">牌/卡</div>
...
<h3>罚牌数: 大 / 小 - 上半场</h3>
<ul>
    <li>预测在半场&ldquo;45分钟&rdquo;比赛结束后总出示的罚牌将大于或小于在盘口指定的大/小盘牌数。 </li>
    <li>如果出示的总罚牌数多于盘口的大/小盘牌数，则为大盘。如果少于盘口的大/小盘牌数，则为小盘。 </li>
...
<ul>
    ...
    <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
    <li>若比赛没有罚牌，比分为0，投注&lsquo;双&rsquo;注单将会盈利。</li>
</ul>
<h3>罚牌数: 单 / 双 - 上半场</h3>
<ul>
    ...
    <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
    <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。 </li>
    <li>若比赛没有罚牌，结果0-0，投注&lsquo;双&rsquo;注单将会盈利。</li>
</ul>
<h3>第一张/最后一张罚牌</h3>
<ul>
...
<ul>
    ...
    <ul>
        ...
        <li>第9分钟后。</li></ul>
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注第一张罚牌时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实出示罚牌的时间为8分钟49秒，罚牌出示时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。 </li>
    <li>针对非球员（例如：教练，没有比赛中替补出场的替补球员，管理人员等等）出示的任何罚牌将不计算在内。 </li>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="FreeKicks">任意球</div>
<h3>任意球：一般规则</h3>
<ul>
...
<ul>
    ...
    <li>若比赛没有任意球，结果为0，投注&lsquo;双&rsquo;注单将会盈利。 </li>
    <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。 </li>
</ul>
<h3>任意球: 单 / 双 - 上半场</h3>
<ul>
    <li>预测45分钟内赛事的总任意球数是单数或双数。 </li>
    <li>若比赛没有任意球，结果为：0，投注&lsquo;双&rsquo;注单将会盈利。 </li>
    <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。 </li>
    <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。 </li>
</ul>
<h3>最先/最后任意球</h3>
...
<ul>
    ...
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注首个任意球时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实发出任意球的时间为8分钟49秒，任意球发出时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。 </li>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="GoalKicks">射门</div>
<h3>球门球：一般规则</h3>
<ul>
...
<ul>
    ...
    <li>若比赛没有球门球，结果为0，投注&lsquo;双&rsquo;注单将会盈利。 </li>
</ul>
<h3>球门球: 单 / 双 - 上半场</h3>
<ul>
...
<ul>
    ...
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注首个球门球时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实发出球门球的时间为8分钟49秒，球门球发出时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。 </li>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="ThrowIns">界外球</div>
...
<ul>
    ...
    <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，总界外球的大/小盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。 </li></ul>
<h3>界外球: 独赢</h3>
<ul>
...
<ul>
    ...
    <li>若比赛没有界外球，结果为：0，投注&lsquo;双&rsquo;注单将会盈利。</li>
</ul>
<h3>界外球: 单 / 双 - 上半场</h3>
<ul>
...
<ul>
    ...
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注首个界外球时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实发出界外球的时间为8分钟49秒，界外球发出时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。 </li>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="Substitutions">替补</div>
...
<ul>
    ...
    <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。 </li>
    <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li></ul>
<h3>替补: 单 / 双</h3>
<ul>
...
<ul>
    ...
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注首个替补时间的选项是&lsquo;赛事的第58分钟或之前&rsquo;，而确实替补的时间为58分钟49秒，替补时间的范围属于&lsquo;第59分钟后&rsquo;，因此投注将结算为输。 </li>
    <li>如果赛事在第一个替补后中断，所有首个替补时间的注单将保持有效。 </li>
    <li>如果赛事在第一个替补前中断，所有首个替补时间的注单将被取消。 </li>
    <li>如果在90分钟完场时间内并未任何替补，所有首个替补时间的注单将被取消。 </li></ul>
<!-- content abc -->

<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="Offsides">越位</div>

<h3>越位：一般规则</h3>
<ul>
    <li>注单的结算将根据官方赛果或赛事权威机构判定的结果为准。</li></ul>
<h3>越位：让球</h3>
<ul>
...
<ul>
    ...
    <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。 </li>
    <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。 </li>
    <li>如果赛事在下半场中断，那么所有投注该盘口注单均视为有效。</li></ul>
<h3>越位: 大 / 小</h3>
<ul>
...
<ul>
    ...
    <li>若比赛没有越位，结果为：0，投注&lsquo;双&rsquo;注单将会盈利。 </li>
...
<ul>
    ...
    <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。 </li>
    <li>范例：如果投注首个越位时间的选项是&lsquo;赛事的第8分钟或之前&rsquo;，而确实球员越位的时间为8分钟49秒，球员越位时间的范围属于&lsquo;第9分钟后&rsquo;，因此投注将结算为输。 </li>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="PenaltyMarkets">点球</div>
...
<ul>
    ...
    <li>如果赛事在点球赛时中断，而在赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，大/小盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。</li></ul>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="Competitions">比赛</div>
...
<ul>
    ...
    <li>投注包括自动晋级以及在加时赛与点球大战后的晋级。</li><li>符合冠军规则。</li></ul>
<h3>比赛 - 阶段淘汰</h3>
<ul>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="">综合市场</div>
<h3>独赢 & 进球 大/小</h3>
<ul>
...
<!-- general rules -->
<div class="acc_rulesSoccer_Title" id="OtherMarkets">其他</div>
<h3>特定联赛里主客队的总进球数</h3>
<p> 本公司在某些联赛里会提供某种结合性赛事结果的投注。盘口的玩法将结合主场与客场球队在整个联赛里的赛果之后分出胜负。中立场的比赛，第一个球队被视为这一场赛事的主队。以下列出所提供的个别替补玩法规则。</p>
<h3>特定联赛里主客队的总进球数：一般规则</h3>
<ul>
...
<h3>特定联赛里主客队的进球数：让球</h3>
<ul>
    <li>预测在90分钟完场时间内哪一支球队在结合整个联赛里的赛果后在盘口指定的让球数胜出。</li></ul>
<h3>特定联赛里主客队的进球数：进球: 大 / 小</h3>
<ul>
