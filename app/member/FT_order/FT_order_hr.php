...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,M_LetB,$m_league as M_League,ShowType,MB_LetB_Rate,TG_LetB_Rate from foot_match where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
//userlog($memname);
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_hr_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
