...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,$M_LetB as M_Dime,$MB_LetB_Rate as MB_Dime_Rate,$TG_LetB_Rate as TG_Dime_Rate from foot_match where `m_start`>now() and `MID`=$gid and cancel<>1 and fopen=1 and mb_team<>'' and mb_team_tw<>'' and mb_team_en<>''";
...
<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_ou15_finish.php" method="post" onSubmit="return false">
<div class="ord">
...
<input type="hidden" value="<?=$langx?>" name=langx>
	...
	<input type="hidden" value="203" name=line_type>
