...
if($cou==0){
	...
	$bet_type1=$zuqiubc.$banchang.$bodan;
	$bet_type1_tw=$zuqiubc_tw.$banchang_tw.$bodan_tw;
	$bet_type1_en=$zuqiubc_en.$banchang_en.$bodan_en;
	if ($active==2){
		$caption=$Soccer." - ".$zaopan;
		$bet_type=$zuqiubc." - ".$zaopanbc."<br>".$banchang."<br>".$bodan;
		$bet_type_tw=$zuqiubc_tw." - ".$zaopanbc_tw."<br>".$banchang_tw."<br>".$bodan_tw;
		$bet_type_en=$zuqiubc_en." - ".$zaopanbc_en."<br>".$banchang_en1."<br>".$bodan_en;
	}else{
		$caption=$Soccer;
		$bet_type=$zuqiubc."<br>".$banchang."<br>".$bodan;
		$bet_type_tw=$zuqiubc_tw."<br>".$banchang_tw."<br>".$bodan_tw;
		$bet_type_en=$zuqiubc_en."<br>".$banchang_en1."<br>".$bodan_en;
...
<div class="ord">
    ...
    <div class="main">
      ...
      <p class="team"><em><?=$s_m_place?></em><font color=#cc0000><?=$Sign?> @ <strong class="light" id="ioradio_id"><?=number_format($M_Rate,2)?></strong></p>
      <div class="betdata">
