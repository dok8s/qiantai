...
if($cou==0){
	...
	$mysql = "select M_Start,maxgold,mb_team as team,M_Date,M_Time,$mb_team as MB_Team,MB_Team_en as MB_Team1,$tg_team as TG_Team,$m_league as M_League,ShowType,MB_LetB_Rate,TG_LetB_Rate,M_LetB from foot_match where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
