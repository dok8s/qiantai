...
$filename="".$site."/app/member/FT_order/FT_order_re.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
$mysql = "select  M_Start,maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team, m_re_letb as M_LetB_HR_en,$m_league as M_League,ShowType,mb_re_letb_rate as MB_LetB_Rate_HR,tg_re_letb_rate as TG_LetB_Rate_HR,mb_ball as MB_Win,tg_ball as TG_Win from foot_match where `MID`=$gid and cancel<>1 and fopen=1 ";//and now()>date_add(m_start,interval 40 second)";
