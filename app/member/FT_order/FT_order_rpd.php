...
$filename="".$site."/app/member/FT_order/FT_order_rpd.php?gid=$gid&uid=$suid&rtype=$gtype&odd_f_type=H&langx=$langx";
...
$mysql = "select  M_Start,maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowType,ior_RH1C0,ior_RH2C0,ior_RH0C0,ior_RH0C1,ior_RH0C2,ior_RH2C1,ior_RH1C1,ior_RH3C0,ior_RH1C2,ior_RH0C3,ior_RH3C1,ior_RH3C2,ior_RH2C2,ior_RH1C3,ior_RH2C3,ior_RH4C0,ior_RH4C1,ior_RH3C3,ior_RH0C4,ior_RH1C4,ior_RH4C2,ior_RH4C3,ior_RH4C4,ior_RH2C4,ior_RH3C4,ior_ROVH from foot_match where `MID`=$gid and cancel<>1 and fopen=1";
...
if($cou==0){
	...
	$havesql="select sum(if((odd_type='I' and m_rate<0),abs(m_rate)*betscore,betscore)) as BetScore from web_db_io where M_Name='$memname' and MID='$gid' and LineType=54 and Mtype='$gtype'";
...
<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_rpd_finish.php" method="post" onSubmit="return false">
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> <?=$run?> - <?=$Correctscore?></div>
...
<input type="hidden" value="<?=$langx?>" name=langx>
	...
	<input type="hidden" value="54" name=line_type>
