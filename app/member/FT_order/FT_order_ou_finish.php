...
//userlog($memname);
	...
	case "C":
		...
		$turn_url=BROWSER_IP."/app/member/FT_order/FT_order_ou.php?gid=".$gid."&uid=".$uid."&type=C&gnum=".$row[TG_MID];
		break;
	case "H":
		...
		$turn_url=BROWSER_IP."/app/member/FT_order/FT_order_ou.php?gid=".$gid."&uid=".$uid."&type=H&gnum=".$row[MB_MID];
		break;
	}
	...
	$bet_type1=$zuqiubc.$quanchang.$daxiao;
	$bet_type1_tw=$zuqiubc_tw.$quanchang_tw.$daxiao_tw;
	$bet_type1_en=$zuqiubc_en.$quanchang_en1.$daxiao_en;
	if ($M_Date==date('m-d')){
		$bet_type=$zuqiubc."<br>".$quanchang."<br>".$daxiao;
		$bet_type_tw=$zuqiubc_tw."<br>".$quanchang_tw."<br>".$daxiao_tw;
		$bet_type_en=$zuqiubc_en."<br>".$quanchang_en1."<br>".$daxiao_en;
		$caption=$Soccer;
	}else{
		$caption=$Soccer." - ".$zaopan;
		$bet_type=$zuqiubc." - ".$zaopanbc."<br>".$quanchang."<br>".$daxiao;
		$bet_type_tw=$zuqiubc_tw." - ".$zaopanbc_tw."<br>".$quanchang_tw."<br>".$daxiao_tw;
		$bet_type_en=$zuqiubc_en." - ".$zaopanbc_en."<br>".$quanchang_en1."<br>".$daxiao_en;
	}
