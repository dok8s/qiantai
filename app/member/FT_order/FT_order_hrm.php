...
$filename="".$site."/app/member/FT_order/FT_order_hrm.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
$mysql = "select mb_ball,tg_ball,maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Win,TG_Win,M_Flat from foot_match where `MID`=$gid and cancel<>1 and fopen=1";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_hrm_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
				...
				<input type="hidden" value="52" name=line_type>
