...
if($row['M_Time']=='H/T'){
		...
		$turn_url=BROWSER_IP."/app/member/FT_order/FT_order_rpd.php?gid=".$gid."&uid=".$uid."&rtype=$gtype&odd_f_type=$odd_type&langx=$langx";
	...
	$turn_url=$turn_url.'&change=1';
	$bet_type1=$zuqiubc.$quanchang.$gunqiu.$bodan;
	$bet_type1_tw=$zuqiubc_tw.$quanchang_tw.$gunqiu_tw.$bodan_tw;
	$bet_type1_en=$zuqiubc_en.$quanchang_en1.$gunqiu_en.$bodan_en;
	
	$bet_type=$zuqiubc."<br>".$quanchang."<br>".$gunqiu." - ".$bodan;
	$bet_type_tw=$zuqiubc_tw."<br>".$quanchang_tw."<br>".$gunqiu_tw." - ".$bodan_tw;
	$bet_type_en=$zuqiubc_en."<br>".$quanchang_en1."<br>".$gunqiu_en." ".$bodan_en;
