...
$filename="".$site."/app/member/FT_order/FT_order_rou.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_rou_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
