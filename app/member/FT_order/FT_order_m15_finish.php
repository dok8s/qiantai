...
//userlog($memname);
	...
	switch($wtype){
		case 'AM':
			$row["M_Flat"]=$row['ior_AMN'];
			$row["MB_Win"]=$row["ior_AMH"];
			$row["TG_Win"]=$row["ior_AMC"];
			...
			break;
		case 'BM':
			$row["M_Flat"]=$row['ior_BMN'];
			$row["MB_Win"]=$row["ior_BMH"];
			$row["TG_Win"]=$row["ior_BMC"];
			...
			break;
		case 'CM':
			$row["M_Flat"]=$row['ior_CMN'];
			$row["MB_Win"]=$row["ior_CMH"];
			$row["TG_Win"]=$row["ior_CMC"];
			$r="30:00 - ".$banchang;
			$r_cn=$cr15;
			$r_tw=$cr15_tw;
			$r_en=$cr15_en;
			break;
		case 'DM':
			$row["M_Flat"]=$row['ior_DMN'];
			$row["MB_Win"]=$row["ior_DMH"];
			$row["TG_Win"]=$row["ior_DMC"];
			...
			break;
		case 'EM':
			$row["M_Flat"]=$row['ior_EMN'];
			$row["MB_Win"]=$row["ior_EMH"];
			$row["TG_Win"]=$row["ior_EMC"];
			...
			break;
		case 'FM':
			$row["M_Flat"]=$row['ior_FMN'];
			$row["MB_Win"]=$row["ior_FMH"];
			$row["TG_Win"]=$row["ior_FMC"];
			$r="75:00 - ".$quanchang;
			$r_cn=$fr15;
			$r_tw=$fr15_tw;
			$r_en=$fr15_en;
	...
	$bet_type1=$zuqiubc.$quanchang.$r15.":".$r_cn.$duying;
	$bet_type1_tw=$zuqiubc_tw.$quanchang_tw.$r15_tw.":".$r_tw.$duying_tw;
	$bet_type1_en=$zuqiubc_en.$quanchang_en1.$r15_en.":".$r_en.$duying_en;
	if ($M_Date==date('m-d')){
	$bet_type=$zuqiubc."<br>".$quanchang."<br>".$r15.":".$r_cn."<br>".$duying;
	$bet_type_tw=$zuqiubc_tw."<br>".$quanchang_tw."<br>".$r15_tw.":".$r_tw."<br>".$duying_tw;
	$bet_type_en=$zuqiubc_en."<br>".$quanchang_en1."<br>".$r15_en.":".$r_en."<br>".$duying_en;
	$caption=$Soccer;
	...
	$bet_type=$zuqiubc." - ".$zaopanbc."<br>".$quanchang."<br>".$r15.":".$r_cn."<br>".$duying;
	$bet_type_tw=$zuqiubc_tw." - ".$zaopanbc_tw."<br>".$quanchang_tw."<br>".$r15_tw.":".$r_tw."<br>".$duying_tw;
	$bet_type_en=$zuqiubc_en." - ".$zaopanbc_en."<br>".$quanchang_en1."<br>".$r15_en.":".$r_en."<br>".$duying_en;
	}

	$s_m_place=filiter_team(trim($s_m_place));
	$bottom1="<font color=\"#0000BB\">[".$r15.":".$r_cn." - ".$duying."]</font>";
	$bottom1_tw="<font color=\"#0000BB\">[".$r15_tw.":".$r_tw." - ".$duying_tw."]</font>";
	$bottom_en1="<font color=\"#0000BB\">[".$r15_en.":".$r_en." - ".$duying_en."]</font>";
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> - 15<?=$fenzhong?><?=$jinqiushu?>:<?=$r?> - <?=$win?></div>
