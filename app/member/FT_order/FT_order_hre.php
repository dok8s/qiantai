...
if($cou==0){
	...
	$ms=explode("<em class=\"bold\">(",$html_data);
	$ms=explode(")",$ms[1]);
	$t_inball=$ms[0];
}
...
$filename="".$site."/app/member/FT_order/FT_order_hre.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
//	if ($Sign==''){
//		wager_order($uid,$langx);
//		echo "<SCRIPT language='javascript'>alert('$stopbet!');parent.location='".BROWSER_IP."/app/member/select.php?uid=$uid&langx=$langx';<script>";
//		exit();
//	}
