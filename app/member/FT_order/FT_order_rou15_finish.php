...
//userlog($memname);
	...
	case "AROU":
		...
		$lx="15".$fz128." : ".$gunqiu.$daxiao1." - ".$fz130." - 14:59".$fz128;
		$lx_tw="15".$fz128_tw." : ".$gunqiu_tw.$daxiao1_tw." - ".$fz130_tw." - 14:59".$fz128_tw;
		$lx_en="15".$fz128_en." : ".$gunqiu_en.$daxiao_en." - ".$fz130_en." - 14:59".$fz128_en;
		$MB_Ball="MB15_Ball";
		$TG_Ball="TG15_Ball";
		break; 
	case "BROU":
		...
		$lx="15".$fz128." : ".$gunqiu.$daxiao1." - 15:00 - 29:59".$fz128;
		$lx_tw="15".$fz128_tw." : ".$gunqiu_tw.$daxiao1_tw." - 15:00 - 29:59".$fz128_tw;
		$lx_en="15".$fz128_en." : ".$gunqiu_en.$daxiao_en." - 15:00 - 29:59".$fz128_en;
		$MB_Ball="MB16_Ball";
		$TG_Ball="TG16_Ball";
		break;	
	case "DROU":
		...
		$lx="15".$fz128." : ".$gunqiu.$daxiao1." - ".$fz129." - 59:59".$fz128;
		$lx_tw="15".$fz128_tw." : ".$gunqiu_tw.$daxiao1_tw." - ".$fz129_tw." - 59:59".$fz128_tw;
		$lx_en="15".$fz128_en." : ".$gunqiu_en.$daxiao_en." - ".$fz129_en." - 59:59".$fz128_en;
		$MB_Ball="MB17_Ball";
		$TG_Ball="TG17_Ball";
		break;	
	case "EROU":
		...
		$lx="15".$fz128." : ".$gunqiu.$daxiao1." - 60:00 - 74:59".$fz128;
		$lx_tw="15".$fz128_tw." : ".$gunqiu_tw.$daxiao1_tw." - 60:00 - 74:59".$fz128_tw;
		$lx_en="15".$fz128_en." : ".$gunqiu_en.$daxiao_en." - 60:00 - 74:59".$fz128_en;
		$MB_Ball="MB18_Ball";
		$TG_Ball="TG18_Ball";
		break;	
	...
	$mysql = "select rcard_h,rcard_c,M_Time,MB_MID,TG_MID,$MB_Ball as MB_Ball,$TG_Ball as TG_Ball,M_Flat,M_League,M_League_tw,M_League_en,ShowType,TG_Team_tw,TG_Team_en,MB_Team_tw,MB_Team_en,M_Date,M_Time,MB_Team,TG_Team,$m_re_dime as MB_Dime,$m_re_dime as TG_Dime,$mb_re_dime_rate as MB_Dime_Rate,$tg_re_dime_rate as TG_Dime_Rate from foot_match where `MID`=$gid and fopen=1";
	...
	switch ($gtype){
	case "O":
		$w_m_place		=	'大'.$row["MB_Dime"];
		$w_m_place_tw	=	'大'.$row["MB_Dime"];
		$w_m_place_en	=	'Over'.$row["MB_Dime"];
		$s_m_place		=	$body_mb_dimes.$row["MB_Dime"];
		$w_m_rate=$ior[0];$ior_m_rate=$ior[1];
		$turn_url=BROWSER_IP."/app/member/FT_order/FT_order_rou15.php?gid=".$gid."&uid=".$uid."&type=C&gnum=".$row[TG_MID];
		break;
	case "U":
		$w_m_place		=	'小'.$row["MB_Dime"];
		$w_m_place_tw	=	'小'.$row["MB_Dime"];
		$w_m_place_en	=	'Under'.$row["MB_Dime"];
		$s_m_place		=	$body_tg_dimes.$row["MB_Dime"];
		$w_m_rate=$ior[1];$ior_m_rate=$ior[0];
		$turn_url=BROWSER_IP."/app/member/FT_order/FT_order_rou15.php?gid=".$gid."&uid=".$uid."&type=H&gnum=".$row[MB_MID];
		break;
	}
...
if ($grape=='U0' or $grape=='O0' or $grape=='U 0' or $grape=='O 0'  ){
	...
	$lines2=$row['M_League']."<br>".$w_mb_team."&nbsp;&nbsp;".$Sign."&nbsp;&nbsp;".$w_tg_team."<font color=\"#0000BB\">[".$lx."]</font>&nbsp;<FONT color=red><b>$inball</b></FONT><br>";
	$lines2=$lines2."<FONT color=#cc0000>$w_m_place</FONT>&nbsp;@&nbsp;<FONT color=#cc0000><b>".$M_Rate1."</b></FONT>";

	$lines2_tw=$row['M_League_tw']."<br>".$w_mb_team_tw."&nbsp;&nbsp;".$Sign."&nbsp;&nbsp;".$w_tg_team_tw."<font color=\"#0000BB\">[".$lx_tw."]</font>&nbsp;<FONT color=red><b>$inball</b></FONT><br>";
	$lines2_tw=$lines2_tw."<FONT color=#cc0000>$w_m_place_tw</FONT>&nbsp;@&nbsp;<FONT color=#cc0000><b>".$M_Rate1."</b></FONT>";

	$lines2_en=$row['M_League_en']."<br>".$w_mb_team_en."&nbsp;&nbsp;".$Sign."&nbsp;&nbsp;".$w_tg_team_en."<font color=\"#0000BB\">[".$lx_en."]</font>&nbsp;<FONT color=red><b>$inball</b></FONT><br>";
