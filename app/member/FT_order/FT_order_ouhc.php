...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,$ratio_ouho as ratio_ouho,$ratio_ouhu as ratio_ouhu,$ior_OUHO as ior_OUHO,$ior_OUHU as ior_OUHU from foot_match where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
if($cou==0){
	...
	$havesql="select sum(if((odd_type='I' and m_rate<0),abs(m_rate)*betscore,betscore)) as BetScore from web_db_io where M_Name='$memname' and MID='$gid' and (LineType=103 or LineType=113) and Mtype='$gtype'";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_ouhc_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
