...
//userlog($memname);
	...
	case "PGFH":
		...
		$leixing=$zuixian;
		$leixing_tw=$zuixian_tw;
		$leixing_en=$zuixian_en;
		$M_Rate=$row["ior_PGFH"];
		break;
	case "PGFC":
		$w_m_place=$w_tg_team;
	...
	case "PGLH":
		...
		$s_m_place=$s_mb_team;
		$leixing=$zuihou;
		$leixing_tw=$zuihou_tw;
		$leixing_en=$zuihou_en;
		$jinqiu=$zuihoujinqiu;
		$M_Rate=$row["ior_PGLH"];
		break;
	case "PGLC":
	...
	$bet_type1=$zuqiubc.$zuixianhou.$leixing;
	$bet_type1_tw=$zuqiubc_tw.$zuixianhou_tw.$leixing_tw;
	$bet_type1_en=$zuqiubc_en.$zuixianhou_en.$leixing_en;
	if ($M_Date==date('m-d')){
		$bet_type=$zuqiubc."<br>".$zuixianhou."<br>".$leixing;
		$bet_type_tw=$zuqiubc_tw."<br>".$zuixianhou_tw."<br>".$leixing_tw;
		$bet_type_en=$zuqiubc_en."<br>".$zuixianhou_en."<br>".$leixing_en;
		$caption=$Soccer;
	...
	else
	{
		...
		$bet_type=$zuqiubc." - ".$zaopanbc."<br>".$zuixianhou."<br>".$leixing;
		$bet_type_tw=$zuqiubc_tw." - ".$zaopanbc_tw."<br>".$zuixianhou_tw."<br>".$leixing_tw;
		$bet_type_en=$zuqiubc_en." - ".$zaopanbc_en."<br>".$zuixianhou_en."<br>".$leixing_en;
	}
