...
if($cou==0){
	...
	//echo "<SCRIPT language='javascript'>self.location='".BROWSER_IP."/app/member/order/order.php?uid=$uid&langx=$langx';</script>";
//	exit;
}else{
	$memname=$row['Memname'];
	$credit=$row['Money'];
//userlog($memname);
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_m_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
