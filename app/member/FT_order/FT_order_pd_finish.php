...
if($cou==0){
	...
	$order='A';
		...
		$bet_type1=$zuqiubc.$quanchang.$bodan;
	$bet_type1_tw=$zuqiubc_tw.$quanchang_tw.$bodan_tw;
	$bet_type1_en=$zuqiubc_en.$quanchang_en1.$bodan_en;
if ($active==2){
	$caption=$Soccer." - ".$zaopan;
	$bet_type=$zuqiubc." - ".$zaopanbc."<br>".$quanchang."<br>".$bodan;
	$bet_type_tw=$zuqiubc_tw." - ".$zaopanbc_tw."<br>".$quanchang_tw."<br>".$bodan_tw;
	$bet_type_en=$zuqiubc_en." - ".$zaopanbc_en."<br>".$quanchang_en1."<br>".$bodan_en;
}else{
	$caption=$Soccer;
	$bet_type=$zuqiubc."<br>".$quanchang."<br>".$bodan;
	$bet_type_tw=$zuqiubc_tw."<br>".$quanchang_tw."<br>".$bodan_tw;
	$bet_type_en=$zuqiubc_en."<br>".$quanchang_en1."<br>".$bodan_en;
...
//exit;
	...
	$lines2_tw=$lines2_tw."<FONT color=#cc0000>$w_m_place</FONT>&nbsp;$bottom1_tw@&nbsp;<FONT color=#cc0000><b>".$M_Rate."</b></FONT>";

	$lines2_en=$row['M_League_en'].$w_mid.$w_mb_team_en."&nbsp;&nbsp;<FONT COLOR=#cc0000><b>".$Sign."</b></FONT>&nbsp;&nbsp;".$w_tg_team_en."<br>";
	$lines2_en=$lines2_en."<FONT color=#cc0000>$w_m_place</FONT>&nbsp;$bottom1_en@&nbsp;<FONT color=#cc0000><b>".$M_Rate."</b></FONT>";
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> - <?=$Correctscore?></div>
