...
$mysql = "select maxgold,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MBMB,MBFT,MBTG,FTMB,FTFT,FTTG,TGMB,TGFT,TGTG from foot_match where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
if($cou==0){
	...
	//if ($active==2){
	//$caption=str_replace($Soccer,trim($EarlyMarket),$BqcOrder);
//}else{
//	$caption=$BqcOrder;
//}
//if($M_Rate==""){
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/FT_order/FT_order_f_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
				...
				<input type="hidden" value="14" name=line_type>
