...
$sql = "select Oid from web_member where Oid='$uid' and Memname='$user'";
...
<?
$mysql="select * from sys800 where Memname='$user' order by id desc";
...
?>
		<tr class="b_rig">
		  <td align="center" height="30"><?=$myrow['phone']?><br><?=$name?></td>
