	...
	<script>
		...
		function getLayer(onelayer,gamerec,odd_f_type){
			...
			if (top.langx=="en-us"){
				...
				onelayer=onelayer.replace("*CON_OUH*",ObjDataFT[gamerec].ratio_o.replace("O","大"));	/*大小球頭*/
				onelayer=onelayer.replace("*CON_OUC*",ObjDataFT[gamerec].ratio_u.replace("U","小"));
			}
