...
switch ($rtype){
	case "all":
		...
		$width=50;
		$upd_msg=$udpsecond;
		$table='<td colspan="2"  id="mygtype" class="bet_game_name"><span class="bet_name_long">篮球 &amp; 美式足球 </span><br><tt class="bet_game">早盘</tt></td>
...
//			document.getElementById("Ordertype").innerHTML=odd_show;
		...
		function change_rtype(){
			...
			parent.location.href="index.php?uid=<?=$uid?>&langx=<?=$langx?>&mtype="+parent.ltype+"&rtype="+rtype;
		}
...
<body  id="MBU" class="bet_r_BKF" onLoad="onLoad();">
