	...
	<? if($rtype=="r"){?>
		<script>
			...
			function getLayer(onelayer,gamerec,odd_f_type){
				...
				onelayer=onelayer.replace("*MORE*",parseAllBets(ObjDataFT[gamerec]));
				//我的最愛
			...
			function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
				...
				var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('VB','"+wtype+"','"+param+"');\" title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+" class='bet_bg_color'>"+ioratio+"</font></a>";//ioratio
...
//	}
			...
			function show_allbets(gid,evt){
				...
				top.browse_ScrollY = getScroll(body_browse);
...
//				body_browse.document.getElementById('refresh_down').style.display="none";
				...
				if(typeof(top.more_fave_wtype) == "undefined" ) top.more_fave_wtype = new Array();
				if(typeof(top.more_fave_wtype[show_more_gid]) == "undefined" ) top.more_fave_wtype[show_more_gid] = new Array();
				var  url="body_var_re_allbets.php?gid="+gid+"&uid="+uid+"&ltype="+ltype+"&langx="+top.langx+"&gtype=VB";
			...
			function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
				...
				var ioratio=eval(ioratio_str);
				var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('VB','"+rewtype[wtype]+"','"+param+"');\" title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+" class='bet_bg_color'>"+ioratio+"</font></a>";
	...
	if($rtype=="pd"){
		...
		<script>
			...
			function parseUrl(uid,odd_f_type,rtype,GameData,gamerec,wtype){
				...
				var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('VB','"+wtype+"','"+param+"');\"  title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+" class='bet_bg_color'>"+ioratio+"</font></a>";
...
//	conscroll.style.display="none";
			...
			function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
				...
				if (urlArray[wtype]!=null){
					team=urlArray[wtype][0].replace("<font color=gray>","").replace("</font>","");
