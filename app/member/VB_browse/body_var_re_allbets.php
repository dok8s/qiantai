...
function liveTVClickEvent(){
	...
	if (TV_eventid != "" && TV_eventid != "null" && TV_eventid != "undefined") {	//判斷是否有轉播
			parent.parent.OpenLive(TV_eventid,"VB");			
...
function closeClickEvent(){
		...
		parent.document.getElementById('more_window').style.display='none';		     
		parent.parent.body_browse.document.getElementById('MVB').className="bodyset VBRE";
...
function getRatioName(wtype,rtype){
	...
	switch(wtype){
		...
		case 'RE':
			...
			break;
		case 'OU':
			ratio_str+= (rtype.slice(-1) =='H')?'_o':'_u';
			break;
		case 'ROU':
			ratio_str += "_"+wtype+(rtype.slice(-1)=='C'?'o':'u');
			break;
		default:
			ratio_str+= "_"+rtype;
			break;
...
function getIor(gdata,wtype,ms_num){
  ...
  var strong = gdata['strong'];	
	...
	if( R_Regex.test(wtype) || OU_Regex.test(wtype) || EO_Regex.test(wtype)){
			var arry = new Array();
			if(EO_Regex.test(wtype)) {
...
function get_ms_str(wtype,ms_num){
	...
	if(OU_Regex.test(wtype)||EO_Regex.test(wtype)){
		if(ms_num==0){
...
<table id="tab_show" border="0" cellspacing="0" cellpadding="0" class="more_table">
	...
	<table id="gameInfo" width="100%" border="0" cellspacing="0" cellpadding="0" class="more_bg_table_vb">
		<tr class="more_bg1">
            <td id="title_showtype" name="title_showtype" class="more_live"><img src="/images/member/zh-tw/more_n.jpg" class="more_n" *MID_DISPLAY*/></td>
            <td></td>
	...
	<div id="movie_myMarkets">
			...
			<div id="favorites_REO6"></div>
 			...
 			<div id="favorites_RM7"></div>
			<div id="favorites_RE7"></div>
			<div id="favorites_ROU7"></div>
			<div id="favorites_REO7"></div>
			
 			<div id="favorites_RM8"></div>
			<div id="favorites_RE8"></div>
			<div id="favorites_ROU8"></div>
			<div id="favorites_REO8"></div>

			<div id="favorites_RM9"></div>
			<div id="favorites_RE9"></div>
			<div id="favorites_ROU9"></div>
			<div id="favorites_REO9"></div>
	</div>
	<!------------------------ my markets ------------------------>
	...
	<div id="movie_mainMarkets">
			...
			<div id="body_RM7"></div>
			<div id="body_RE7"></div>
			<div id="body_ROU7"></div>
			<div id="body_REO7"></div>

			<div id="body_RM8"></div>
			<div id="body_RE8"></div>
			<div id="body_ROU8"></div>
			<div id="body_REO8"></div>

			<div id="body_RM9"></div>
			<div id="body_RE9"></div>
			<div id="body_ROU9"></div>
			<div id="body_REO9"></div>
	</div>
			...
			<!--table id="model_ROU" border="0" cellpadding="0" cellspacing="0" class="more_table2">
				<tr>
						<th class="more_title4" colspan="2">
							...
							<span class="more_og2">*MS_STR*</span>
							<span class="more_star_bg"><span id="star_ROU*MS*" name="star_ROU*MS*" onClick="addFavorites('ROU*MS*');" class="star_down" title="加到“我的盘口”"></span></span>
						</th>
				</tr>
