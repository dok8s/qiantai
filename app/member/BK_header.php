...
$sql = "select language,status,memname ,loginName,Money,language,pay_Type from web_member where Oid='$uid' and Oid<>'' and Status<>0";
...
<body id="H<?=$style?>"  class="bodyset" onLoad="SetRB('BK','<?=$uid?>');onloaded();">
...
<div id="container">
  ...
  <div id="header"><span><h1>&nbsp;</h1></span></div>
    ...
    <ul class="level1">
      ...
      <li class="rb" id="rb_btn" style="visibility:hidden;"><a href="#" onClick="chg_rb_index_head('<?=BROWSER_IP?>/app/member/BK_header.php?uid=<?=$uid?>&showtype=&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=re_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BK_lid_type,'<?=CASINO?>');" id="rbyshow"><?=$RunningBall?></a>
        
 
      
      </li>
      <li class="today" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="javascript:chg_button_bg('BK','today');chg_index('<?=BROWSER_IP?>/app/member/BK_header.php?uid=<?=$uid?>&showtype=&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=all&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BK_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early_on" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span><a href="#" onClick="chg_button_bg('BK','early');chg_type('<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=all&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BU_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
  ...
  <div id="type" style="display:none;">
    <ul>
      <!--li class="all"><a href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=r_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');">全部</a></li-->
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=all&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BU_lid_type,'<?=CASINO?>');chg_type_class('re_class');"><?=$rangf?></a></li>
      <!--li class="qt"><a href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=rq4&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');">单节</a></li-->
      <!--li class="re"><a href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=re_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');">滚球</a></li-->
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_type_class('hpa_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=BK&mtype=<?=$mtype?>" onClick="parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');top.hot_game='';"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BK&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('BK','rb');chg_type('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=re_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');chg_type_class('rb_class');"><?=$rangf1?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BK&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BK','rb');chg_type_class('result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
  <!-- 滚球Menu End -->
  ...
  <div id="welcome">
    <ul class="level1">
      ...
      <li class="rb" id="rb_btn" style="visibility:hidden;"><a href="#" onClick="chg_head('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=re_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BK_lid_type,'<?=CASINO?>'); chg_button_bg('BK','rb');" id="rbyshow" style="display:;"><?=$RunningBall?></a>
      
        
 
      
      </li>
      <li class="today_on" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="#" onClick="chg_button_bg('BK','today');chg_type('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=r_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span><a href="javascript:chg_button_bg('BK','early');chg_index('<?=BROWSER_IP?>/app/member/BK_header.php?uid=<?=$uid?>&showtype=future&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/BK_future/index.php?rtype=r_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BU_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
      <li class="live_tv"><a href="#" onClick="OpenLive()" >&nbsp;</a></li>
	  <? if($pay_Type==1){ ?>
      <li class="early_on" id=""><span id="todayType" style="display:none;">在线存款</span><a href="<?=$address ?>/register.php?uid=<?=$uid?>&langx=<?=$langx?>&username=<?=$memname ?>"  target="body"id="todayshow" style="display:;">在线存款</a></li> 
  ...
  <div id="type" style="display:none;">
    <ul>
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('BK','today');chg_type('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=r_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');chg_type_class('re_class');"><?=$rangf?></a></li>
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_button_bg('BK','today');chg_type_class('hpa_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=BK&mtype=<?=$mtype?>" onClick="chg_button_bg('BK','today');parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');top.hot_game='';"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BK&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BK','today');chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
      <li class="re"><a id="rb_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('BK','rb');chg_type('<?=BROWSER_IP?>/app/member/BK_browse/index.php?rtype=re_main&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',top.BK_lid_type,'<?=CASINO?>');chg_type_class('rb_class');"><?=$rangf1?></a></li>
      <li class="result"><a id="rb_result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BK&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BK','rb');chg_type_class('rb_result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
</div>
 <? }?>
