...
//userlog($memname);
	...
	$mysql = "select * from volleyball where `MID`=$gid and fopen=1";
...
switch ($gtype){
		...
		$grape=$Sign;
		if ($showtype==''){
			$turn_url=$turn_url.'&langx='.$langx.'&change=1';
	...
	$turn_url=$turn_url.'&langx=$langxchange=1';
	...
	$bet_type1=$paiqiubc.$quanchang.$gunqiu.$rangfen;
	$bet_type1_tw=$paiqiubc_tw.$quanchang_tw.$gunqiu_tw.$rangfen_tw;
	$bet_type1_en=$paiqiubc_en.$quanchang_en1.$gunqiu_en.$rangfen_en;
	$bet_type=$paiqiubc."<br>".$quanchang."<br>".$gunqiu." - ".$rangfen;
	$bet_type_tw=$paiqiubc_tw."<br>".$quanchang_tw."<br>".$gunqiu_tw." - ".$rangfen_tw;
	$bet_type_en=$paiqiubc_en."<br>".$quanchang_en1."<br>".$gunqiu_en." ".$rangfen_en;
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> <?=$str_RB?> - <?=$rang?></div>
