...
$mysql = "select maxgold,mb_team as team,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Win,TG_Win,M_Flat from volleyball  where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/VB_order/VB_order_m_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
