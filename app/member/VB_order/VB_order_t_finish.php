...
$accept=0;
	...
	case 5:
		...
		$caption=$DsOrder;
		$turn_rate="VB_Turn_EO_".$opentype;
		switch ($gtype){
		case "ODD":
			$w_m_place='单';
			$w_m_place_tw='單';
	...
	$bet_type1=$paiqiubc.$quanchang.$danshuang;
	$bet_type1_tw=$paiqiubc_tw.$quanchang_tw.$danshuang_tw;
	$bet_type1_en=$paiqiubc_en.$quanchang_en1.$danshuang_en;
	$bet_type=$paiqiubc."<br>".$quanchang."<br>".$danshuang;
	$bet_type_tw=$paiqiubc_tw."<br>".$quanchang_tw."<br>".$danshuang_tw;
	$bet_type_en=$paiqiubc_en."<br>".$quanchang_en1."<br>".$danshuang_en;

	$s_m_place=filiter_team(trim($s_m_place));

	$M_Rate=number_format($M_Rate,2);
