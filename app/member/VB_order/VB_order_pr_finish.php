...
for($i=0;$i<count($data)-1;$i++){
	...
	$bet_place2_en=$bet_place2_en.$w_l_team_en." <font color=#cc0000>$sign</font> ".$w_r_team_en."<br>";
...
$w_bettype="网球".$count.'串1';
$w_bettype_tw="呼瞴".$count.'﹃1';
$w_bettype_en="tennis".$count.'parlay1';
...
$active=4;
$mysql="insert into web_db_io(wtype,auth_code,hidden,super,MID,Active,LineType,Mtype,M_Date,Middle,Middle_tw,Middle_en,M_Rate,M_Name,OpenType,BetTime,Agents,BetScore,ShowType,BetType,BetType_tw,BetType_en,M_Place,Gwin,TurnRate,world,corprator,agent_rate,world_rate,agent_point,world_point,betip,pay_type,corpor_turn,orderby,corpor_point,status) values ('PR','$auth_code','$hidden','$super','$mid','$active','8','$w_mtype','$m_date','$bet_place2','$bet_place2_tw','$bet_place2_en','$w_m_rate','$memname','$OpenType','$bettime','$agid','$gold','$showType','$w_bettype','$w_bettype_tw','$w_bettype_en','$w_mtype2','$gwin','$turn','$world','$corprator','$agent_rate','$world_rate','$agent_point','$world_point','$ip_addr','$pay_type','$corpro_rate','$order','$corpor_point','0')";
