...
$base_url = "".$site."/app/member/VB_index.php?rtype=re&uid=$suid&mtype=3";
$thisHttp = new cHTTP();
$thisHttp->setReferer($base_url);
$filename="".$site."/app/member/VB_order/VB_order_re.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
$mysql = "select maxgold,mb_team as team ,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team, M_RE_LetB as M_LetB_HR_en,$m_league as M_League ,ShowType,mb_letb_rate as MB_LetB_Rate_HR,tg_letb_rate as TG_LetB_Rate_HR from volleyball where `MID`=$gid and cancel<>1 and fopen=1";
