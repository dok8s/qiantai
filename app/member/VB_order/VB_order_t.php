...
$mysql = "select maxgold,mb_team as team,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,S_Single,S_Double from volleyball where `MID`=$gid and cancel<>1 and fopen=1";// `m_start`>now() and
...
if($cou==0){
	...
	$GMAX_SINGLE1=$row['VB_EO_Scene'];
	$GSINGLE_CREDIT1=$row['VB_EO_Bet'];
	$GMAX_SINGLE2=$row['VB_T_Scene'];
	$GSINGLE_CREDIT2=$row['VB_T_Bet'];
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/VB_order/VB_order_t_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
