...
<SCRIPT language=JavaScript src="/js/football_order<?=$body_js?>.js"></SCRIPT>
</head>
<?


$mysql = "select maxgold,mb_ball,tg_ball,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,concat('$body_mb_dimes',m_re_dime) as MB_Dime,concat('$body_tg_dimes',m_re_dime) as TG_Dime,mb_re_dime_rate as MB_Dime_Rate,tg_re_dime_rate as TG_Dime_Rate from foot_match where `MID`=$gid and cancel<>1 and fopen=1";
...
//	if ($M_Rate<0 or $M_Place==''){
//		echo "<SCRIPT language='javascript'>alert('$stopbet');self.location='/app/member/select.php?uid=$uid';</script>";
//		exit();
//	}
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/BS_order/BS_order_hrou_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
