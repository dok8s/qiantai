...
//判断此赛程是否已经关闭：取出此场次信息
$mysql = "select * from baseball where `MID`=$gid and cancel<>1 and fopen=1 and mb_inball=''";
...
if($cou==0){
	...
	$bet_type1=$bangqiubc.$quanchang.$bet_type;
	$bet_type1_tw=$bangqiubc_tw.$quanchang_tw.$bet_type_tw;
	$bet_type1_en=$bangqiubc_en.$quanchang_en1.$bet_type_en;
	$bet_type=$bangqiubc."<br>".$quanchang."<br>".$bet_type;
	$bet_type_tw=$bangqiubc_tw."<br>".$quanchang_tw."<br>".$bet_type_tw;
	$bet_type_en=$bangqiubc_en."<br>".$quanchang_en1."<br>".$bet_type_en;
