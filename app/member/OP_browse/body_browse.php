...
$table0=' <td colspan="2" id="mygtype" class="bet_game_name">其它<br><tt class="bet_game">'.$jinri.'</tt></td>
            ...
            <td class="bet_title_ou"><span><tt>'.$Odd.'/'.$Even.'</tt></span></td>';
$table1=' <th class="time">'.$Times.'</th>
          <th class="team">'.$HomeTeam.'</th>
          <th>'.$win.'</th>
          <th>'.$Handicap.'</th>
          <th>'.$OverUnder.'</th>';
$table2='<td colspan="2" id="mygtype" class="bet_game_name">其它<br><tt class="bet_game">'.$run.'</tt></td>
        <td class="bet_title_hdp"><span>'.$res_total.'<br><tt>'.$Handicap.'</tt></span></td>
        <td class="bet_title_ou"><span>'.$res_total.'<br><tt>'.$OverUnder2.'</tt></span></td>
        <td class="bet_title_dp"><span>'.$hsthalf.'<br><tt>'.$Handicap.'</tt></span></td>
        <td class="bet_title_hou"><span>'.$hsthalf.'<br><tt>'.$OverUnder2.'</tt></span></td>';
...
$table5='<th class="time">'.$Times.'</th>
          ...
          <th>4:4</th>
          <th>'.$pdother.'</th>';
$table6='<th class="time">'.$Times.'</th>
          <th class="num">'.$res_mid.'</th>
          <th class="team">'.$HomeTeam.'</th>
          <th class="pr">'.$Handicap.'</th>
          <th class="ou">'.$OverUnder.'</th>';
...
$table8=' <td colspan="2" id="mygtype" class="bet_game_name">其它<br><tt class="bet_game">'.$zhgg.'</tt></td>
            <td class="bet_title_1X2"><span><tt>'.$win.'</tt></span></td>
            <td class="bet_title_hdp"><span><tt>'.$rang.'</tt></span></td>
            <td class="bet_title_ou"><span><tt>'.$OverUnder2.'</tt></span></td>
            <td class="bet_title_ou"><span><tt>'.$Odd.'/'.$Even.'</tt></span></td>';
...
//			refresh_right.style.top=document.body.scrollTop+39;
		...
		function reload_var(Level){
			...
			var homepage = tmp+"?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&mtype="+parent.ltype+"&page_no="+parent.pg+"&league_id="+l_id;
...
//						}else{
			...
			console.log(top.ShowLoveIarray[gtype]);
		...
		// new array{ , new array {gid ,data time ,,H,C,sw}}
...
<div id=DataTR style="display:none;">
	<xmp>
		...
		<? if($rtype=="r"){?>
			...
			<!--SHOW LEGUAGE END-->
			<tr id="TR_*ID_STR*" class="bet_game_tr_top" *TR_EVENT*>
				<td rowspan="3" class="bet_game_time"><div>*DATETIME*</div></td>
			...
			<tr id="TR2_*ID_STR*" *CLASS* *TR_EVENT* class="bet_game_tr_other">
				<td class="bet_team"><div class="bet_text_table_draw"><span class="bet_text_tdstar">*MYLOVE*</span></div></td>
				<td class="bet_text">*RATIO_MN*</td>
				<td colspan="3" class="bet_text">*MORE*</td>
			</tr>
		<? }
		if($rtype=="re"){
			?>
			...
			<!--SHOW LEGUAGE END-->
			<tr id="TR_*ID_STR*" class="bet_game_tr_top" *TR_EVENT*>
				<td rowspan="2" class="bet_game_time"><table border="0" cellpadding="0" cellspacing="0" class="rb_box"><tr><td class="rb_time">*SE*</td></tr><tr><td class="rb_score">*SCORE*</td></tr></table></td>
				<td class="bet_team">*TEAM_H*</td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_thin">*CON_RH*</tt></span><span class="bet_text_tdr">*RATIO_RH*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_OUH*</tt></span><span class="bet_text_tdr">*RATIO_OUH*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_HRH*</tt></span><span class="bet_text_tdr">*RATIO_HRH*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_HOUH*</tt></span><span class="bet_text_tdr">*RATIO_HOUH*</span></div></td>
			</tr>
			<tr id="TR1_*ID_STR*" *TR_EVENT* class="bet_game_tr_other">
				...
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_thin">*CON_RC*</tt></span><span class="bet_text_tdr">*RATIO_RC*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_OUC*</tt></span><span class="bet_text_tdr">*RATIO_OUC*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_HRC*</tt></span><span class="bet_text_tdr">*RATIO_HRC*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_oue">*CON_HOUC*</tt></span><span class="bet_text_tdr">*RATIO_HOUC*</span></div></td>
			</tr>
		<? }
		if($rtype=="p3"){
			?>
