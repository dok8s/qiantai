...
?>
<!--SCRIPT language=javaScript src="/js/VB_mem_showgame_<?=$rtype?>.js" type=text/javascript></SCRIPT-->
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0">
  <frame name="body_var" scrolling="NO" noresize src="body_var.php?uid=<?=$uid?>&rtype=<?php echo $rtype?>&langx=<?=$langx?>&mtype=3&g_date=<?=$g_date?>&league_id=<?=$league_id?>">
  <frame name="body_browse" src="body_browse.php?uid=<?=$uid?>&rtype=<?php echo $rtype?>&langx=<?=$langx?>&mtype=3">
</frameset>
