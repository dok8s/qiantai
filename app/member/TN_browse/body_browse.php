...
switch ($rtype){
	case "r":
		...
		$body_id="MTN";
		$body_calss="TNR";
		$table='<td colspan="2"  id="mygtype" class="bet_game_name"><span class="bet_name_long">网球 </span><br><tt class="bet_game">'.$jinri.'</tt></td>
...
<td class="bet_title_tp"></td>';
		break;
	case "re":
		$caption=$Tennis.":".$RunningBall;
		$upd_msg=$udpsecond;
		$body_id="MTN";
		$body_calss="TNRE";
		$table='<td colspan="2" id="mygtype"class="bet_game_name">网球<br><tt class="bet_game">'.$run.'</tt></td>
            <td class="bet_title_hdp"><span><tt>'.$bk_pralayr.'</tt></span></td>
            <td class="bet_title_ou"><span><tt>'.$OverUnder2.'</tt></span></td>
            <td class="bet_title_ou"></td>';
		break;
	case "pd":
		$caption=$wangqiu.":".$saipan;
		$show="PD";
		$width=30;
		$body_id="MTN";
		$body_calss="TNPD";
		$upd_msg=$Paicai;
		$table='<td colspan="2" class="bet_game_name">网球<br><tt class="bet_game">'.$jinri.'</tt></td>
	...
	case "pr":
		...
		$body_id="MTN";
		$body_calss="TNPD";
		$table='<td colspan="2"  id="mygtype" class="bet_game_name"><span class="bet_name_long">网球 </span><br><tt class="bet_game">'.$zhgg.'</tt></td>
...
//conscroll.style.top=document.body.scrollTop;
		...
		function count_down(){
			...
			if (parent.retime_flag == 'Y'){
				if(parent.reTimeNow <= 0){
					if(parent.loading_var == 'N')
						reload_var("");
					return;
				}
				parent.reTimeNow--;
				rt.innerHTML=parent.reTimeNow;
				//alert(parent.retime);
...
<div id=DataTR style="display:none;" >
	<xmp>
		...
		<? switch ($rtype){
			case "r":
				...
				<tr id="TR_*ID_STR*" *TR_EVENT* class="bet_game_tr_top">
					...
					<td  rowspan="2" class="bet_textbor_bg">*TV*</td>
				</tr>
		...
		if($rtype=="re"){
			?>
			<tr *ST*  class="bet_game_league" >
				<td colspan="5" onClick="parent.showLeg('*LEG*')">*LEG*</td>
			</tr>
			<!--SHOW LEGUAGE END-->
			<tr id="TR_*ID_STR*" *TR_EVENT* class="bet_game_tr_top">

				<td rowspan="2" class="b_cen tn_w">
					<table cellpadding="0" cellspacing="0" border="0" class="bet_point_table" *NOWSERVER*>
						<tr>
							<td class="bet_point_line"><span class="bet_point_left">*GAMEH*</span></td><td class="bet_point_line"><span class="bet_point_left">*SETH*</span></td><td class="bet_point_rew"><span class="bet_point_right">*POINTH*</span><td class="bet_line"><span *NOWH*></span></td>
						</tr>
						<tr>
							<td class="bet_point_line"><span class="bet_point_other">*GAMEC*</span></td><td class="bet_point_line"><span class="bet_point_other">*SETC*</span></td><td class="bet_point_rew"><span class="bet_point_right">*POINTC*</span><td class="bet_line"><span *NOWC*></span></td>
						</tr>
					</table>
					<table cellpadding="0" cellspacing="0" border="0" class="bet_point_line_table" *TR_OTHERS*>
						<tr>
							<td rowspan="2">
								*COUNT*
							</td>
							<td class="bet_line"></td>
						</tr>
					</table>
				</td>
				<td class="bet_team"><div class="bet_team_div_or_200">*TEAM_H*</div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_thin">*CON_RH*</tt></span><span class="bet_text_tdr">*RATIO_RH*</span></div></td>
				<td class="bet_text"><div class="bet_text_table"><span class="bet_text_tdl"><tt class="bet_text_thin">*CON_OUH*</tt></span><span class="bet_text_tdr">*RATIO_OUH*</span></div></td>
				<td  rowspan="2" class="bet_textbor_bg">*TV*</td>
			</tr>
			<tr id="TR1_*ID_STR*" *TR_EVENT* class="bet_game_tr_other">
				<td class="bet_team"><div class="bet_text_table"><span class="bet_text_tdl">*TEAM_C* </span><span class="bet_text_tdstar">*MYLOVE*</span></div></td>
