...
<frameset rows="118,*" cols="*" frameborder="NO" border="0" framespacing="0"> 
  <frame name="header" scrolling="NO" noresize src="<?=BROWSER_IP?>/app/member/VB_header.php?uid=<?=$uid?>&showtype=<?=$header?>&langx=<?=$langx?>&mtype=3" >
  <frameset cols="240,1*" frameborder="NO" border="0" framespacing="0"> 
    <frame name="mem_order" noresize scrolling="NO" src="<?=BROWSER_IP?>/app/member/select.php?uid=<?=$uid?>&langx=<?=$langx?>">
    <frame name="body" src="<?=BROWSER_IP?>/app/member/<?=$showtype?>/index.php?uid=<?=$uid?>&langx=<?=$langx?>">
  </frameset>
</frameset>
