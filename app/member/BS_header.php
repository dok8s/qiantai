...
<body id="H<?=$style?>" class="bodyset" onLoad="SetRB('BS','<?=$uid?>');onloaded();">
...
<div id="container">
 ...
 <? if($showtype=='future'){?>
    ...
    <ul class="level1">
	  ...
	  <li class="rb" id="rb_btn" style="visibility:hidden;"><a href="<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" onClick="chg_button_bg('BS','rb');" target="body"><?=$RunningBall?></a> </li>
	  
      <li class="today" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="javascript:chg_button_bg('BS','today');chg_index('<?=BROWSER_IP?>/app/member/BS_header.php?uid=<?=$uid?>&showtype=&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BS_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early_on" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span> <a href="#" onClick="chg_button_bg('BS','early');chg_type('<?=BROWSER_IP?>/app/member/BS_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BSFU_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
  ...
  <div id="type" style="display:none;">
    <ul>
      <li class="re" ><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/BS_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BSFU_lid_type,'<?=CASINO?>');chg_type_class('re_class');"><?=$dd1?></a></li>
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?=BROWSER_IP?>/app/member/BS_future/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_type_class('hpa_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=BS&mtype=<?=$mtype?>" onClick="parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BS&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
	  <li class="re" ><a  id="rb_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('BS','rb');chg_type('<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BS_lid_type,''<?=CASINO?>'); chg_type_class('rb_class');"><?=$rangfdaxiao?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BS&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BS','rb');chg_type_class('result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
  <!-- 滚球Menu End -->
</div>
 ...
 <div id="welcome">
    <ul class="level1">
      ...
      <li class="name"><?=$nihao?>, <strong id="userid"><?=$loginName?></strong>
    	...
    	<li class="rb" id="rb_btn" style="visibility:hidden;"><span id="rbType"></span><a href="#" onClick="chg_head('<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>&showtype=',parent.BS_lid_type,'<?=CASINO?>'); chg_button_bg('BS','rb');"  id="rbyshow" style="display:;"><?=$RunningBall?></a>
      
      </li>
      <li class="today_on" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="#" onClick="chg_button_bg('BS','today');chg_type('<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BS_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span> <a href="javascript:chg_button_bg('BS','early');chg_index('<?=BROWSER_IP?>/app/member/BS_header.php?uid=<?=$uid?>&showtype=future&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/BS_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BSFU_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
      <li class="live_tv"><a href="#" onClick="OpenLive()" >&nbsp;</a></li>
	  <? if($pay_Type==1){ ?>
      <li class="early_on" id=""><span id="todayType" style="display:none;">在线存款</span><a href="<?=$address ?>/register.php?uid=<?=$uid?>&langx=<?=$langx?>&username=<?=$memname ?>"  target="body"id="todayshow" style="display:;">在线存款</a></li> 
  ...
  <div id="type" style="display:none;">
    <ul>
      <!--li class="rb"><a id="rb_class" class="type_out" href="<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" onClick="chg_button_bg('BS','rb');chg_type_class('rb_class');" target="body"><?=$RunningBall?><span class="rb_sum"> (<span class="game_sum" id="subRB_games"></span>)</span></a></li-->
      <li class="re" ><a  id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('BS','today');chg_type('<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.BS_lid_type,'<?=CASINO?>'); chg_type_class('re_class');"><?=$dd1?></a></li>
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?=BROWSER_IP?>/app/member/BS_browse/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_button_bg('BS','today');chg_type_class('hpa_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=BS&mtype=<?=$mtype?>" onClick="chg_button_bg('BS','today');parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BS&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BS','today');chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
      ...
      <li class="result"><a id="rb_result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=BS&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('BS','rb');chg_type_class('rb_result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
