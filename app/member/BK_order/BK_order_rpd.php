...
$filename="".$site."/app/member/BK_order/BK_order_rpd.php?gid=$gid&uid=$suid&rtype=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
/*/赛事前五分钟封盘	
	...
	$havesql="select sum(if((odd_type='I' and m_rate<0),abs(m_rate)*betscore,betscore))  as BetScore from web_db_io where m_name='$memname' and MID='$gid' and linetype=121 and mtype='$gtype' and active=3";
...
<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_rpd_finish.php" method="post" onSubmit="return false">
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$xzlb1?> - <?=$zoudi?><?=$qiuduidefen?><?=$M_Place?> -<?=$zuihouyiwei?></div>
  ...
  <div class="ord" id="line_window" style="display: none;">
	...
	<input type=hidden value=121 name=line_type>
