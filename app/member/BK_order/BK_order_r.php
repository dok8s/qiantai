...
$filename="".$site."/app/member/BK_order/BK_order_r.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx&strong=$strong";
...
$mysql = "select M_Start, mb_team,mb_mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowType,MB_LetB_Rate,TG_LetB_Rate,M_LetB as M_LetB_en from bask_match where `MID`='$gid'  and cancel<>1 and fopen=1";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_r_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
				...
				<input type=hidden value=2 name=line_type>
				...
				<input type=hidden value=<?=$strong?> name=strong>
