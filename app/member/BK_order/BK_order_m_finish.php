...
//userlog($memname);
	...
	$bettime=date('Y-m-d H:i:s');
		...
		case "H":
			...
			$s_m_place=$s_mb_team;
			$w_m_rate=$row['ior_MH'];
			$turn_url=BROWSER_IP."/app/member/BK_order/BK_order_m.php?gid=".$gid."&uid=".$uid."&type=H&gnum=".$row[TG_MID];
			break;
		case "C":
			$w_m_place=$w_tg_team;
			...
			$s_m_place=$s_tg_team;
			$w_m_rate=$row['ior_MC'];
			$turn_url=BROWSER_IP."/app/member/BK_order/BK_order_m.php?gid=".$gid."&uid=".$uid."&type=C&gnum=".$row[MB_MID];
			break;
		}
	...
	$bet_type1=$lanqiubc.$bet_type.$duying1;
	$bet_type1_tw=$lanqiubc_tw.$bet_type_tw.$duying1_tw;
	$bet_type1_en=$lanqiubc_en.$bet_type_en.$duying1_en;
	$bet_type=$lanqiubc."<br>".$bet_type."<br>".$duying1;
	$bet_type_tw=$lanqiubc_tw."<br>".$bet_type_tw."<br>".$duying1_tw;
	$bet_type_en=$lanqiubc_en."<br>".$bet_type_en."<br>".$duying1_en;
if ($w_m_rate==''){
		echo "<script language='javascript'>self.location='$turn_url';</script>";
		exit();
	}
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> - <?=$duyingpan?></div>
