...
//userlog($memname);
	...
	case "O":
		...
		$turn_url=BROWSER_IP."/app/member/BK_order/BK_order_ouhc.php?gid=".$gid."&uid=".$uid."&type=O&wtype=".$wtype;
		break;
	case "U":
		...
		$turn_url=BROWSER_IP."/app/member/BK_order/BK_order_ouhc.php?gid=".$gid."&uid=".$uid."&type=U&wtype=".$wtype;
		break;
	}
...
//		}
	...
	$bet_type1=$lanqiubc.$bet_type.$qdjf1.$qiudui.$daxia1o;
	$bet_type1_tw=$lanqiubc_tw.$bet_type_tw.$qdjf1_tw.$qiudui_tw.$daxiao1_tw;
	$bet_type1_en=$lanqiubc_en.$bet_type_en.$qdjf1_en.$qiudui_en.$daxiao1_en;
	$bet_type=$lanqiubc."<br>".$bet_type."<br>".$qdjf1.$qiudui." - ".$daxiao1;
	$bet_type_tw=$lanqiubc_tw."<br>".$bet_type_tw."<br>".$qdjf1_tw.$qiudui_tw." - ".$daxiao1_tw;
	$bet_type_en=$lanqiubc_en."<br>".$bet_type_en."<br>".$qdjf1_en.$qiudui_en." - ".$daxiao1_en;
	if ($w_m_rate==''){
		echo "<script language='javascript'>parent.location='".BROWSER_IP."/app/member/select.php?uid=$uid&langx=$langx';</script>";
		exit();
	}
	...
	$bottom1="<font color=\"#0000BB\">[".$qdjf1.$qiudui." - ".$daxiao1."]</font>";
	$bottom1_tw="<font color=\"#0000BB\">[".$qdjf1_tw.$qiudui_tw." - ".$daxiao1_tw."]</font>";
	$bottom_en1="<font color=\"#0000BB\">[".$qdjf1_en.$qiudui_en." - ".$daxiao1_en."]</font>";
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> - <?=$qdjf?> <? if($wtype=='OUH'){echo $s_mb_team ;}else{echo $s_tg_team;}?> - <?=$ou?></div>
