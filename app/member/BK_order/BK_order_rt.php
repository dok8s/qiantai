...
$base_url = "".$site."/app/member/BK_index.php?rtype=rt&uid=$suid&langx=$langx&mtype=3";
$thisHttp = new cHTTP();
$thisHttp->setReferer($base_url);
$filename="".$site."/app/member/BK_order/BK_order_rt.php?gid=$gid&uid=$suid&rtype=$gtype&odd_f_type=H&langx=$langx";
...
//	}
	...
	$havesql="select sum(BetScore) as BetScore from web_db_io where m_name='$memname' and MID=$gid and linetype=15 and active=3";// and mtype='$gtype'";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_rt_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
				...
				<input type=hidden value=15 name=line_type>
