...
//userlog($memname);
	...
	$bettime=date('Y-m-d H:i:s');
		...
		case "PDH0":
			...
			$wtype='PDH';
			$turn_url=BROWSER_IP."/app/member/BK_order/BK_order_pd.php?gid=".$gid."&uid=".$uid."&type=$gtype&gnum=".$row[TG_MID];
			break;
		case "PDH1":
			$w_m_place=$w_mb_team;
			$w_m_place_tw=$w_mb_team_tw;
	...
	$bet_type1=$lanqiubc.$bet_type.$qiuduidefen1.$w_m_place." -".$zuihouyiwei1;
	$bet_type1_tw=$lanqiubc_tw.$bet_type_tw.$qiuduidefen1_tw.$w_m_place_tw." -".$zuihouyiwei1_tw;
	$bet_type1_en=$lanqiubc_en.$bet_type_en.$qiuduidefen1_en.$w_m_place_en." -".$zuihouyiwei1_en;
	$bet_type=$lanqiubc."<br>".$bet_type."<br>".$qiuduidefen1.$w_m_place." -".$zuihouyiwei1;
	$bet_type_tw=$lanqiubc_tw."<br>".$bet_type_tw."<br>".$qiuduidefen1_tw.$w_m_place_tw." -".$zuihouyiwei1_tw;
	$bet_type_en=$lanqiubc_en."<br>".$bet_type_en."<br>".$qiuduidefen1_en.$w_m_place_en." -".$zuihouyiwei1_en;
if ($w_m_rate==''){
		echo "<script language='javascript'>parent.location='".BROWSER_IP."/app/member/select.php?uid=$uid&langx=$langx';</script>";
		exit();
	}
	...
	$bottom1="<font color=\"#0000BB\">[".$qiuduidefen1.$w_m_place." -".$zuihouyiwei1."]</font>";
	$bottom1_tw="<font color=\"#0000BB\">[".$qiuduidefen1_tw.$w_m_place_tw." -".$zuihouyiwei1_tw."]</font>";
	$bottom_en1="<font color=\"#0000BB\">[".$qiuduidefen1_en.$w_m_place_en." -".$zuihouyiwei1_en."]</font>";
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> - <?=$qiuduidefen?><?=$s_m_place?> -<?=$zuihouyiwei?></div>
