...
//userlog($memname);
	...
	$bet_type1=$lanqiubc.$bet_type.$gunqiu.$danshuang;
	$bet_type1_tw=$lanqiubc_tw.$bet_type_tw.$gunqiu_tw.$danshuang_tw;
	$bet_type1_en=$lanqiubc_en.$bet_type_en.$gunqiu_en.$danshuang_en;
	$bet_type=$lanqiubc."<br>".$bet_type."<br>".$gunqiu.' - '.$danshuang;
	$bet_type_tw=$lanqiubc_tw."<br>".$bet_type_tw."<br>".$gunqiu_tw.' - '.$danshuang_tw;
	$bet_type_en=$lanqiubc_en."<br>".$bet_type_en."<br>".$gunqiu_en.' - '.$danshuang_en;
...
<div class="ord">
    ...
    <div class="main">
      ...
      <div class="gametype"><?=$res_total?> <?=$str_RB?> - <?=$OddEven?></div>
