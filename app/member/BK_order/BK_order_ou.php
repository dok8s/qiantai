...
$filename="".$site."/app/member/BK_order/BK_order_ou.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
$mysql = "select mb_team,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,concat('$body_mb_dimes',m_dime) as MB_Dime,concat('$body_tg_dimes',m_dime) as TG_Dime,m_dime,MB_Dime_Rate,TG_Dime_Rate from bask_match where `MID`=$gid and cancel<>1 and fopen=1";
...
//userlog($memname);
	...
	$havesql="select sum(if((odd_type='I' and m_rate<0),abs(m_rate)*betscore,betscore)) as BetScore from web_db_io where m_name='$memname' and MID='$gid' and linetype=3 and mtype='$gtype' and active=3";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_ou_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
