...
$filename="".$site."/app/member/BK_order/BK_order_rm.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
/*/赛事前五分钟封盘	
	...
	$havesql="select sum(if((odd_type='I' and m_rate<0),abs(m_rate)*betscore,betscore))  as BetScore from web_db_io where m_name='$memname' and MID='$gid' and linetype=11 and mtype='$gtype' and active=3";
...
?>
	...
	<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_rm_finish.php" method="post" onSubmit="return false">
		<div class="ord_main">
			<div class="ord_DIV">
				...
				<input type=hidden value=11 name=line_type>
