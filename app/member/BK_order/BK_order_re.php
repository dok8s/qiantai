...
$filename="".$site."/app/member/BK_order/BK_order_re.php?gid=$gid&uid=$suid&type=$gtype&gnum=$gnum&odd_f_type=H&langx=$langx";
...
$mysql = "select M_Start,mb_team,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowType,MB_LetB_Rate,TG_LetB_Rate,M_LetB as M_LetB_en from bask_match where `MID`='$gid' and cancel<>1 and fopen=1";
...
//userlog($memname);
	$GMAX_SINGLE=$mrow['BK_RE_Scene'];
	$GSINGLE_CREDIT=$mrow['BK_RE_Bet'];
	$open=$mrow['OpenType'];
...
//		echo "<SCRIPT language='javascript'>alert('$stopbet2');self.location='/app/member/select.php?uid=$uid';</script>";
//		exit();
//	}
