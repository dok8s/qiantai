...
if ($act==1){
	...
	for ($i=1;$i<$teamcount+1;$i++){
		...
		if (!empty($type)){
			...
			$sql="select mid,m_date,$gnum as gnum,$team as team,$teama,showtype,concat($m_league,'-','$HandicapParlay') as lea,$team_s as team_s,$ratio as ratio from bask_match where mid=$gid";// and m_start>now()
...
<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_p3_finish.php" method="post" onSubmit="return false">
	<div class="ord_main">
		<div class="ord_DIV">
			<h1><?=$zhgg?></h1>
			<div class="main">
