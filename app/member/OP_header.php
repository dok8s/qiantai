...
<body id="H<?=$style?>" class="bodyset" onLoad="SetRB('OP','<?=$uid?>');onloaded();">
...
<div id="container">
  ...
  <div id="header"><span>
	...
	<li class="rb" id="rb_btn" style="visibility:hidden;"><a href="<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" onClick="chg_button_bg('OP','rb');" target="body"><?=$RunningBall?></a> </li>
	
      <li class="today" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="javascript:chg_button_bg('OP','today');chg_index('<?=BROWSER_IP?>/app/member/OP_header.php?uid=<?=$uid?>&showtype=&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early_on" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span><a href="#" onClick="chg_button_bg('OP','early');chg_type('<?=BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OM_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
  ...
  <div id="type" style="display:none;">
    <ul>
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OM_lid_type,'<?=CASINO?>');chg_type_class('re_class');"><?=$duying?></a></li>
      <li class="hp3"><a id="hp3_class" class="type_out" href="<?=BROWSER_IP?>/app/member/OP_future/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_type_class('hp3_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=OP&mtype=<?=$mtype?>" onClick="parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');top.hot_game='';"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=OP&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
	  <li class="re"><a  id="rb_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','rb');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,''<?=CASINO?>'); chg_type_class('rb_class');"><?=$rangq?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=OP&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('OP','rb');chg_type_class('result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
  <!-- 滚球Menu End -->
</div>
    ...
    <ul class="level1">
      ...
      <li class="rb" id="rb_btn" style="visibility:hidden;"><a href="#" onClick="chg_head('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>'); chg_button_bg('OP','rb');" id="rbyshow" style="display:;"><?=$RunningBall?></a>
      
     
      
      </li>
      <li class="today_on" id="today_btn"><span id="todayType" style="display:none;"><?=$jrss?></span><a href="#" onClick="chg_button_bg('OP','today');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');" id="todayshow" style="display:;"><?=$jrss?></a></li>
      <li class="early" id="early_btn"><span id="earlyType" style="display:none;"><?=$zaopan?></span><a href="javascript:chg_button_bg('OP','early');chg_index('<?=BROWSER_IP?>/app/member/OP_header.php?uid=<?=$uid?>&showtype=future&langx=<?=$langx?>&mtype=<?=$mtype?>','<?=BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>&showtype=future',parent.OM_lid_type,'<?=CASINO?>');" id="earlyshow" style="display:;"><?=$zaopan?></a></li>
      <!--Live TV-->
      <li class="live_tv"><a href="#" onClick="OpenLive()" >&nbsp;</a></li>
	  <? if($pay_Type==1){ ?>
      <li class="early_on" id=""><span id="todayType" style="display:none;">在线存款</span><a href="<?=$address ?>/register.php?uid=<?=$uid?>&langx=<?=$langx?>&username=<?=$memname ?>"  target="body"id="todayshow" style="display:;">在线存款</a></li> 
  ...
  <div id="type" style="display:none;">
    <ul>
      <!--li class="rb"><a id="rb_class" class="type_out" href="#" onClick="chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>'); chg_button_bg('OP','rb');chg_type_class('rb_class');" ><?=$RunningBall?><span class="rb_sum"> (<span class="game_sum" id="subRB_games"></span>)</span></a></li-->
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','today');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');chg_type_class('re_class');"><?=$duying?></a></li>
      <!--li class="hr"><a href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=hr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');">上半场</a></li>
      <!--<li class="pd"><a id="pd_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','today');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');chg_type_class('pd_class');">波胆</a></li> -->
      <!--li class="hrp"><a href="javascript:void(0);" onClick="chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=hpd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');">上半波胆</a></li-->
      <!--<li class="to"><a id="to_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','today');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=t&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');chg_type_class('to_class');">总入球</a></li> -->
      <!--<li class="hf"><a id="hf_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','today');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=f&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');chg_type_class('hf_class');">半场 / 全场</a></li> -->
      <!--<li class="par"><a href="<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body">标准过关</a></li>
			<li class="hpa"><a href="<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body">让球过关</a></li>-->
      <li class="hp3"><a id="hp3_class" class="type_out" href="<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>" target="body" onClick="chg_button_bg('OP','today');chg_type_class('hp3_class');"><?=$zhgg?></a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?=BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?=$uid?>&langx=<?=$langx?>&FStype=OP&mtype=<?=$mtype?>" onClick="chg_button_bg('OP','today');parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');top.hot_game='';"  target="body"><?=$Guan?></a></li>
      <li class="result"><a id="result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=OP&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('OP','today');chg_type_class('result_class');"><?=$saiguo?></a></li>
    </ul>
  </div>
  <!-- Today Menu End -->
  ...
  <div id="type_re" style="display:none;">
    <ul>
      <li class="re"><a id="rb_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('OP','rb');chg_type('<?=BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=<?=$mtype?>',parent.OP_lid_type,'<?=CASINO?>');chg_type_class('rb_class');"><?=$rangq?></a></li>
      <li class="result"><a id="rb_result_class" class="type_out" href="<?=BROWSER_IP?>/app/member/result/result.php?game_type=OP&uid=<?=$uid?>&langx=<?=$langx?>" target="body" onClick="chg_button_bg('OP','rb');chg_type_class('rb_result_class');"><?=$saiguo?></a></li>
     </ul>
  </div>    
