...
<HEAD><TITLE></TITLE>
	...
	<SCRIPT language=JavaScript>
        ...
        $base_url = "".$site."/app/member/BS_browse/index.php?rtype=$rtype&uid=$suid&langx=$langx&mtype=$mtype&league_id=";
        $filename="".$site."/app/member/BS_browse/body_var.php?rtype=$rtype&uid=$suid&langx=$langx&mtype=$mtype&delay=&league_id=&hot_game=";
        $curl = &new Curl_HTTP_Client();
        $curl->store_cookies("cookies.txt");
        $curl->set_user_agent("Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)");
        $curl->set_referrer($base_url);
        $meg=$curl->fetch_url($filename);
//        $meg .= gzinflate(substr($meg,10));
        ...
        switch ($rtype){
            case "r":
                ...
                for($i=0;$i<$cou;$i++){
                    ...
                    $sql = "update baseball set display=$i,ShowType='$datainfo[7]',M_LetB='$datainfo[8]',M_Dime='$m_dime',MB_LetB_Rate='$datainfo[9]',TG_LetB_Rate='$datainfo[10]',TG_Dime_Rate='$datainfo[13]',MB_Dime_Rate='$datainfo[14]',MB_Win='$datainfo[15]',TG_Win='$datainfo[16]',s_single='$datainfo[20]',s_double='$datainfo[21]',r_show=3 where MID=$datainfo[0]";
                ...
                break;
            case "re":
                $sql="update baseball set RE_Show=0 where RE_show=1 and ((uptime +  INTERVAL 30 SECOND) < now() or or uptime='0000-00-00 00:00:00')";
                mysql_db_query($dbname,$sql);
                echo "parent.GameHead = new Array('gid','timer','league','gnum_h','gnum_c','team_h','team_c','strong','ratio','ior_RH','ior_RC','ratio_o','ratio_u','ior_OUH','ior_OUC','no1','no2','no3','score_h','score_c','hgid','hstrong','hratio','ior_HRH','ior_HRC','hratio_o','hratio_u','ior_HOUH','ior_HOUC','lastestscore_h','lastestscore_c','eventid','hot','center_tv','play','datetime');\n";
                echo "parent.minlimit_VAR='';\n";
                echo "parent.maxlimit_VAR='';\n";
                ...
                for($i=0;$i<$cou;$i++){
                    ...
                    $sql = "update baseball set m_time='$status',fopen=$close,ShowType='$datainfo[7]',M_re_LetB='$datainfo[8]',M_re_Dime='$m_re_dime',MB_re_LetB_Rate='$datainfo[9]',TG_re_LetB_Rate='$datainfo[10]',TG_re_Dime_Rate='$datainfo[13]',MB_re_Dime_Rate='$datainfo[14]',mb_ball='$datainfo[18]',tg_ball='$datainfo[19]',rcard_h='$datainfo[27]',rcard_c='$datainfo[28]',uptime='".date('Y-m-d H:i:s')."',RE_Show=1 where MID=$datainfo[0]";
            ...
            */
            ...
            case "p":
            /*
            $mysql = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_Sleague,MB_P_Win,TG_P_Win,M_P_Flat,MB_MID,TG_MID,ShowType from baseball where `m_start` > now( ) and p_Show=1 AND `m_Date` ='$mDate'".$league."  and mb_team<>'' and mb_team_tw<>'' and mb_team_en<>'' and cancel<>1 order by display";
            $result = mysql_db_query($dbname, $mysql);
            ...
            */
                ...
                for($i=0;$i<$cou;$i++){
                    ...
                    $messages=str_replace("cha(9)","",$messages);
                    $datainfo=eval("return $messages;");
                    $sql = "update baseball set MB_PR_LetB_rate='$datainfo[9]',TG_PR_letb_rate='$datainfo[10]',MB_PR_Dime_Rate='$datainfo[13]',TG_PR_Dime_Rate='$datainfo[14]',PR_Show=1 where MID=$datainfo[0]";
                    mysql_db_query($dbname,$sql) or die(error);


                    if ($league_id<>''){
                        if ($league_id==$dateinfo[2]){
                            echo "parent.GameFT[$K]= Array('$datainfo[0]','$datainfo[1]','$datainfo[2]','$datainfo[3]','$datainfo[4]','$datainfo[5]','$datainfo[6]','$datainfo[7]','$datainfo[8]','$datainfo[9]','$datainfo[10]','$datainfo[11]','$datainfo[12]','$datainfo[13]','$datainfo[14]');\n";
                            $K=$K+1;
                        }
                    }else{
                        echo "parent.GameFT[$K]= Array('$datainfo[0]','$datainfo[1]','$datainfo[2]','$datainfo[3]','$datainfo[4]','$datainfo[5]','$datainfo[6]','$datainfo[7]','$datainfo[8]','$datainfo[9]','$datainfo[10]','$datainfo[11]','$datainfo[12]','$datainfo[13]','$datainfo[14]');\n";
