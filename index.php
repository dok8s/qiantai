...
require ("app/member/include/library.mem.php");
...
if ($row['website']==1) {
    ...
    <head>
        ...
        <style type="text/css">
            ...
            html, body {
                ...
                padding: 0;
                text-align: center;
                background: url(images/fix_bg.gif) repeat-x 0 298px;
                font-size: 12px;
    ...
    <table width="1049" border="0" cellpadding="0" cellspacing="0" id="box">
        <tr>
            <td align="right"><img src="images/fix_1.jpg" width="263" height="188"/><img src="images/fix_2.gif"
                                                                                         width="613" height="188"/></td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                            ...
                            <table width="351" border="0" cellspacing="0" cellpadding="0" class="info">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="email">电子邮箱:<br/>
                                        royal888crown@hotmail.com
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td valign="top" class="main">
                            <table width="364" border="0" cellspacing="0" cellpadding="0" class="info">
                                <tr>
                                    <td colspan="2"><img src="images/fix_4.gif" alt="" width="327" height="84"/></td>
                                </tr>
                                <tr>
                                    <td height="73" colspan="2" valign="top"><p>Service Disruption Period -
                                            <em><?= date('d') ?> <?= $m_en ?> <?= date('Y') ?></em><br/>
                                            <?= $row['systime'] ?>(GMT +08:00) </p></td>
                                </tr>
                                <tr>
                        ...
                        <td valign="top" class="main2">
                            <table width="334" border="0" cellspacing="0" cellpadding="0" class="info">
                                ...
                                <tr>
                                    <td height="73" colspan="2" valign="top"><p>ระยะเวลาที่ไม่สามารถให้บริการ -
                                            <em><?= date('d') ?> <?= $m_en ?> <?= date('Y') ?></em><br/>
    ...
    if ($uid <> '') {
        ...
        <html>
        <head>
            <meta name="baidu-site-verification" content="iRLPoe1gAK"/>

            <title>Welcome</title>
            <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        </head>
        <frameset rows="*,0,0" frameborder="NO" border="0" framespacing="0">
            <frame name="<?= CASINO ?>_mem_index"
                   src="app/member/index.php?uid=<?= $uid ?>&mtype=<?= $mtype ?>&langx=<?= $langx ?>">
            <frame name="<?= CASINO ?>_func" scrolling="NO" noresize src="./ok.html">
        ...
        <frameset rows="*,0,0" frameborder="NO" border="0" framespacing="0">
            <frame name="<?= CASINO ?>_mem_index" src="app/member/index.php?uid=<?= $uid ?>&mtype=<?= $mtype ?>&langx=<?= $langx ?>">
            <frame name="<?= CASINO ?>_func" scrolling="NO" noresize src="../ok.html">
        </frameset>
        <noframes>
            <body bgcolor="#FFFFFF" text="#000000">
