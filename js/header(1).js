...
function chg_button_bg(gtype,btn){
	...
	//alert("chg_button_bg="+top.head_gtype+",btn="+btn);
	//parent.mem_order.HOT_rb_btn.className = "rb_left_"+langx+"_out";
	//parent.mem_order.HOT_today_btn.className = "hot_left_"+langx+"_out";
	//parent.mem_order.HOT_early_btn.className = "early_left_"+langx+"_out";
	...
	if (btn=="early"||btn=="today"){
		...
		/*if(btn=="early"){
			parent.mem_order.HOT_early_btn.className = "early_left_"+langx+"_on";
		}else{
			parent.mem_order.HOT_today_btn.className = "hot_left_"+langx+"_on";
		}*/
	}
	if (btn=="rb"){
		...
		//parent.mem_order.HOT_rb_btn.className = "rb_left_"+langx+"_on";
	}
	if (btn!="rb"){
		if(btn=="early"){
			top.head_FU="FU";	
...
function OpenLive(){
	...
	var DWinObj = window.open("./live/live.php?langx="+top.langx+"&uid="+top.uid+"&liveid="+top.liveid+"&autoOddCheck="+top.autoOddCheck,"Live","width=780,height=580,top=0,left=0,status=no,toolbar=no,scrollbars=no,resizable=no,personalbar=no");
...
function Go_RB_page(RBgtype){
	...
	parent.body.location.href=protocol+"//"+document.domain+"/app/member/"+RBgtype+"_browse/index.php?rtype=re&uid="+top.uid+"&langx="+top.langx+"&mtype="+top.mtype+"&showtype="+top.showtype+"&hot_game="+top.hot_game;
}
