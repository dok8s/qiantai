...
function Go_Chg_pass(uid,langx){
	Real_Win=window.open("../../../app/member/account/chg_passwd.php?uid="+top.uid+"&langx="+top.langx,"Chg_pass","width=492,height=228,status=no,location=no");
}
function OpenLive(){
